...
@section('right-content')
    ...
    <div class="row">
        <form method="post" id="form_plist" target="report_preview" action="{{url('donation/print_paylist')}}">
            {{csrf_field()}}
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="col-md-1">
                                    <button type="button" id="btnDisplayPaylist" class="btn btn-sm btn-default">Display
                                        Pay List
                                    </button>
                                </div>
                            </div>
...
{{--                    only for chrome browser--}}
                    <div id="content_area" style="display: none">
                        <form method="post" action="{{url('donation/print_paylist')}}">
                            {{csrf_field()}}
...
@section('scripts')
    ...
    {{Html::script('public/site_resource/js/donation_script/paylist.script.js')}}
    <script>
