...
@section('scripts')
    ...
    re_year = "{{url('donation/re_year')}}";
        ...
        cc_budget_display = "{{url('donation/cc_budget_display')}}";
        insert_cc_budget = "{{url('donation/insert_cc_budget')}}";
        cc_budget_history = "{{url('donation/cc_budget_history')}}";
                    ...
                    if (add_current_amount == '') {
                        ...
                        $.ajax({
                            ...
                            success: function (resp) {
                                ...
                                var subtract_dist_amount = resp[0]['subtract_dist_amount'];
                                var subtract_exp_amount = resp[0]['subtract_exp_amount'];
                                console.log(subtract_dist_amount);
                                console.log(subtract_exp_amount);
                                // if ((Math.abs(proposed_negative_amount) <= subtract_dist_amount) && (Math.abs(proposed_negative_amount) <= subtract_exp_amount))
                                if ( Math.abs(proposed_negative_amount) <= subtract_exp_amount) {
                                    ...
                                    toastr.info('Subtraction amount exceeds expense amount or distribution amount');
                                }
