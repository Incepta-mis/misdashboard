...
@section('title','BEFTN Maintenance')
@section('styles')
                    ...
                    <div class="form-horizontal">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                {!! Form::open(array('url'=>'donation/upload_beftn_master','method'=>'POST' ,
                                ...
                                <!-- <div class="form-group">
                                    <div class="col-md-6 col-sm-12" >  
                                        ...
                                        ('donation/downloadFile')}}"><i class="fa fa-hand-o-right"></i> Here </a>to see the sample file.</span></label>
                                    </div>
                                </div> -->
                            </div>
                        </div>
                        ...
                        <form class="form-horizontal">
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-12">
                                            <label class="control-label col-md-3" for="report_date">Beneficiary ID</label>
                                            <div class="col-md-6 col-xs-11">
                                                <input class="form-control form-control-inline input-medium
                                                " name="ben_id" id="ben_id" size="16" type="text"
                                                       value="ALL" />
                                            </div>
                                        </div> 
                                        <div class="col-md-6 col-sm-12">
                                            <label class="control-label col-md-3" for="pro_source">Territory Code</label>
                                            <div class="col-md-6 col-xs-11">
                                                <select id="terr_id" name="terr_id"
                                                        class="form-control form-control-inline input-medium">
                                                    <option value="ALL" selected>ALL</option>
                                                    @foreach($display_data['territory'] as $c)
                                                        <option value="{{$c->territory_code}}">{{$c->territory_code}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 col-sm-12 table-responsive">
                            <table id="listTable" width="100%" class="table table-bordered table-condensed table-striped">
                                <thead style="background-color: #46B8DA;">
                                <tr>             
                                    <th>territory_code</th>
                                    <th>d_name</th>
                                    <th>beneficiary_id</th>
                                    <th>beneficiary_name</th>
                                    <th>beneficiary_contact_number</th>
                                    <th>beneficiary_bank_account_name</th>
                                    <th>bank_account_no</th>
                                    <th>bank_name</th>
                                    <th>bank_branch_name</th>
                                    <th>routing_number</th>
                                    <th>account_holder_address</th>
                                    <th>rm_terr_id</th>
                                    <th>rm_name</th>
                                    <th>dsm_name</th>
                                    <th>remarks</th>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{  url('donation/beftn_info') }}',
                    data: { 'terr_id': terr_id, 'ben_id': ben_id, '_token': "{{ csrf_token() }}"},
                    success: function (data) {
                        ...
                        table = $("#listTable").DataTable({
                            ...
                            columns: [
                                ...
                                {data: "beneficiary_bank_account_name"},
