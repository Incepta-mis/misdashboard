...
@section('title','Yearly Product Ranking')
@section('styles')
        ...
        <div class="col-sm-12">
            <section class="panel" id="data_table">
                <header class="panel-heading">
                    <label style="float: left;">Brand Ranking Report ( Yearly) </label>
                        ...
                        <div id="export_buttons" style="margin-left: 87%;">
                            <div class="dt-buttons btn-group">
                                <a class="btn btn-default buttons-excel buttons-html5 btn-sm btn-primary"
                                   tabindex="0" href="{{ route('yearlyProductRankExcel') }}" aria-controls="tab_prds" id="rank_excel" >
...
@section('scripts')
    ...
    <script>
        url = "{{url('srep/hrep/hbrand/resp_year_wise_prank')}}";
