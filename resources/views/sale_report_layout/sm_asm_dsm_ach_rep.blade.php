        ...
        <div class="col-sm-12">
            <section class="panel" id="data_table">
                <header class="panel-heading">
                    <label style="float:left;width:80.0%">DSM/SM Wise Performance
                        &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp Figures in <span style="color:green">Crore</span>&nbsp&nbsp &nbsp  &nbsp &nbsp<span style="color:blue">BDT <span id="export_buttons"></span> </span></label>
...
@section('scripts')
    ...
    <script>
        var dsm_wise_url = "{{url('srep/resp_sm_dsm_achment')}}";
