                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="n_id"
                                                       class="col-md-4 col-sm-6 control-label s_font"><b>NID</b></label>
                                                <div class="col-md-8">
                                                    <select name="n_id"
                                                            id="n_id"
                                                            class="form-control input-sm"
                                        ...
                                        <div class=" col-md-4" style="padding: 0 90px;">
                                            <button type="button" id="display_data_exam_record"
                        ...
                        <div class="table-responsive">
                            <table id="detail_list" class="table table-condensed table-striped table-bordered"
                                ...
                                <tr>
                                    ...
                                    <th>Written Exam Point</th>
                                    <th>1st Interview PM</th>
                                    <th>1st Interview Date</th>
                                    <th>1st Interview Points</th>
                                    <th>Final Interview PM</th>
                                    <th>Final Interview Date</th>
                                    <th>Final Interview Points</th>
                                    <th>Total Points</th>
                                </tr>
                                </thead>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#plant_name").on('change', function () {
                ...
                $.ajax({
                    type: "post",
                    url: '{{url('rms/report/wir_get_dept_info')}}',
                    datatype: 'json',
                    data: {
                        _token: '{{csrf_token()}}',
                        plant_id: plant_id
            ...
            $("#department_name").on('change', function () {
                ...
                $.ajax({
                    type: "post",
                    url: '{{url('rms/report/wir_get_section_info')}}',
                    datatype: 'json',
                    data: {
                        _token: '{{csrf_token()}}',
                        dept_id: dept_id
            ...
            $("#recruitment_id").on('change', function (){

                $.ajax({
                    type: "post",
                    url: '{{url('rms/report/wir_get_n_id')}}',
                    datatype: 'json',
                    data: {
                        _token: '{{csrf_token()}}',
                        rec_id: $("#recruitment_id").val()
                    },
                    success:function (response){
                        console.log(response.get_n_id);

                        var data_path = response.get_n_id;
                        var option_nid = '';

                        option_nid += "<option value='ALL'>ALL</option>";

                        for (var j = 0; j < data_path.length; j++) {
                            var nid = data_path[j]['nid'];
                            option_nid += "<option value='" + nid + "'>" + nid + "</option>";
                        }

                        $("#n_id").empty().append(option_nid);
                    }
                })

            });

            $("#display_data_exam_record").on('click', function () {
                ...
                if (plant_id === "") {
                    ...
                    $.ajax({
                        type: "post",
                        url: '{{url('rms/report/get_data_exam_record')}}',
                        datatype: 'json',
                        data: {
                            _token: '{{csrf_token()}}',
                        ...
                        success: function (response) {
                            ...
                            console.log("Exam Record:", response);
                            ...
                            var var_table = $("#detail_list").DataTable({
                                data: response['get_data_exam_record'],
                                dom: '<"toolbar">Bfrtip',
                                buttons: [
                                    {
                                ...
                                columns: [
                                    ...
                                    {data: "candidate_name"},
                                    {data: "g_university"},
                                    {data: "format_written_exam_date"},
                                    {data: "written_exam_point"},
                                    {data: "interview_pm"},
                                    {data: "format_interview_date"},
                                    {data: "interview_point"},
                                    {data: "f_interview_pm"},
                                    {data: "format_f_interview_date"},
