                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="add2">
                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 sticky-top">
                                                            ...
                                                            <div class="form-horizontal">
                                                                <div class="col-md-12 col-sm-12">
                                                                        ...
                                                                        {{-- <form action="" class="form-horizontal" role="form"> --}}
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <label for="search_plant_name"
                                                                                    class="control-label s_font"
                                                                                    style="padding: 0;"><b>Plant
                                                                                    Name</b></label>
                                                                                    <select name="search_plant_name"
                                                                                    id="search_plant_name"
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col-md-12"
                                                                        style="margin:  0;">
                                                                        <label for="search_department_name"></label>
                                                                        <select name="search_department_name"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        ID</b></label>
                                                        <select name="search_recruitment"
                                                        id="search_recruitment"
                                ...
                                <div class="col-md-3"
                                style="margin-top: 20px; padding: 0 9px">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 sticky-top">
                                    ...
                                    <div class="form-horizontal">
                                        <div class="col-md-12 col-sm-12">
                                                ...
                                                {{-- <form action="" class="form-horizontal" role="form"> --}}
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            style="padding: 0;"><b>Plant
                                                            Name</b></label>
                                                            <select name="search_plant_name1"
                                                            id="search_plant_name1"
                                            ...
                                            <div class="form-group">
                                                ...
                                                Name</b></label>
                                                <select name="search_department_name1"
                                                id="search_department_name1"
                            ...
                            <div class="form-group">
                                ...
                                style="padding: 0;"><b>Recruitment
                                ID</b></label>
                                <select name="search_recruitment1"
                                id="search_recruitment1"
...
<div class="row">
    ...
    <div class="form-group">
        ...
        <select name="source_reference1"
        id="source_reference1"
                ...
                table = $("#example").DataTable({
                    ...
                    },
                    {
                        ...
                        "render": function (row) {
                            ...
                            if (row === null) {
                                return '<input id="candidate_name" name="candidate_name" disabled type="text" value="">';
                            } else {
                                return '<input id="candidate_name" name="candidate_name" readonly value="' + row + '" type="text">';
                            }
                    ...
                    },
                    {
                        data: null,
                        "render": function (row) {
                            return '<select name="medical_result" id="medical_result"> <option  value="" >Select</option> <option value="Positive">Positive</option> <option value="Negative">Negative</option> </select>';
                        }
                    },
                    {
                        data: null,
                    ...
                    },
                    {
                        data: null,
                        "render": function (row) {
                            return '<select name="assessment" id="assessment"> <option  value="">Select</option> <option value="Selected">Selected</option> <option value="Waiting">Waiting</option> <option value="Not Selected">Not Selected</option> </select>';
                        }
                    },
                    ],
                    language: {
...
$(document).on('change', '.search_department_name1', function (e) {
    ...
    $.ajax({
        type: "post",
        url: '{{url('rms/csf_search1_get_rec_id')}}',
        datatype: 'json',
        data: {
            _token: '{{csrf_token()}}',
            dept_id: dept_id,
        ...
        success: function (response) {
            ...
            var data_path = response.csf_search1_get_rec_id;
            var option_vacant = '';
...
$(document).on('change', '.search_recruitment1', function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            source_reference += "<option value='' selected >SELECT</option>";
...
$(document).on('change', '.source_reference1', function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            var vnid = '';
            vnid += "<option value='' selected >SELECT</option>";
...
let tbl = '';
$(document).on('click', '#btn-fupdate', function () {
    console.log('Yes Clicked...');

            // var plant_info = $('.search_plant_name1').val();
            // var plant_id = plant_info.split('|')[0];
            // var search_department_name1 = $('.search_department_name1').val();
            var recrut_id = $('.search_recruitment1').val();
            var source_reference1 = $('.source_reference1').val();
            var nid = $('.nid').val();

            /*console.log(plant_id);
            console.log(search_department_name1);
            console.log(recrut_id);
            console.log(source_reference1);
            console.log(nid);*/
            ...
            refreshDataTable(recrut_id, source_reference1, nid);


        });

function refreshDataTable(recrut_id, source_reference1, nid) {
    $.ajax({
        type: "post",
        url: '{{url('rms/getDataForUpdate')}}',
        datatype: 'json',
        data: {
            _token: '{{csrf_token()}}',
                    // plant_id: plant_id,
                    // search_department_name1: search_department_name1,
                    recrut_id: recrut_id,
                    source_reference1: source_reference1,
                    nid: nid
                },
                success: function (response) {
                    console.log("for update=", response);
                    $("#loader").hide();
                    $("#report-body").show();
                        ...
                        },
                        {
                            ...
                            "render": function (row) {
                                ...
                                if (row === null) {
                                    ...
                                    if (row === 'Positive') {
                                        return '<select name="medical_result" id="medical_result"><option  value="" >Select...</option> <option selected value="' + row + '">' + row + '</option> <option value="Negative">Negative</option> </select>';
                                    } else {
                                        return '<select name="medical_result" id="medical_result"><option  value="" >Select...</option> <option selected value="' + row + '">' + row + '</option> <option value="Positive">Positive</option>  </select>';
                                    }
                                }
                            }
                        },
                        {
                            data: 'medical_result_image',
                            "render": function (row) {
                                if (row === null) {
                                    return '<div class="custom-file"> <input type=file name="mfile" class="custom-file-input mfile"> <label class="custom-file-label" for="file">Choose Images</label> </div>';
                                } else {
                                    let p_image = '<?php echo url(''); ?>' + '/public' + row;
                                        // return '<img src="' + p_image  + '" alt="' + p_image  + '" height="16" width="16"/>';
                                        return '<a href="' + p_image + '" target="_blank">Medical Image</a> | ' +
                                        ' <div class="custom-file"> <input type=file name="mfile"  class="custom-file-input mfile"> <label class="custom-file-label" for="file">Choose Images</label> </div>';
                                    }
                            ...
                            },
                            {
                                ...
                                "render": function (row) {
                                    if (row === null) {
                                        return '<select name="assessment" id="assessment"> <option disabled value="">Select...</option> <option value="Selected">Selected</option> <option value="Waiting">Waiting</option> <option value="Not Selected">Not Selected</option> </select>';
                                    } else {
                                        if (row === 'Selected') {
                                            return '<select name="assessment" id="assessment"><option  value="" >Select...</option> <option selected value="' + row + '">' + row + '</option> <option value="Waiting">Waiting</option> <option value="Not Selected">Not Selected</option> </select>';
                                        } else if (row === 'Waiting') {
                                            return '<select name="assessment" id="assessment"><option  value="" >Select...</option> <option selected value="' + row + '">' + row + '</option> <option value="Selected">Selected</option> <option value="Not Selected">Not Selected</option> </select>';
                                        } else {
                                            return '<select name="assessment" id="assessment"><option  value="" >Select...</option> <option selected value="' + row + '">' + row + '</option> <option value="Waiting">Waiting</option> <option value="Selected">Selected</option> </select>';
                                        }
                                    }
...
$(document).on('click', '.accept', function () {
    ...
    let frm_source_reference1 = $('.source_reference1').val();
    let frm_nid = $('.nid').val();

    let recrut_id = $(this).closest('tr').find('td:eq(0) input').val();
    let source_reference1 = $(this).closest('tr').find('td:eq(1) input').val();
    let nid = $(this).closest('tr').find('td:eq(2) input').val();
    let medical_result = $(this).closest('tr').find('td:eq(10) select').val();
    let candidate_assessment = $(this).closest('tr').find('td:eq(12) select').val();
    let image_file = $(this).closest('tr').find('.mfile').prop('files');
            // console.log(image_file[0]);
            let formData = new FormData();
            formData.append('file', image_file[0]);
            formData.append("recrut_id", recrut_id);
            formData.append("source_reference1", source_reference1);
            formData.append("candidateNID", nid);
            formData.append("medical_result", medical_result);
            formData.append("candidate_assessment", candidate_assessment);
            let url = "{{ url('rms/csf_post_cas_data') }}";
            $.ajax({
                url: url,
                type: 'post',
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf_token"]').attr('content')},
                ...
                success: function (data) {
                    ...
                    if (data.success) {
                        ...
                        console.log(frm_source_reference1);
                        console.log(frm_nid);

                        if (frm_source_reference1 === 'ALL' && frm_nid === 'ALL') {
                            refreshDataTable(recrut_id, frm_source_reference1 = 'ALL', frm_nid = 'ALL');
                        } else if (frm_nid === 'ALL') {
                            refreshDataTable(recrut_id, frm_source_reference1, frm_nid = 'ALL');
                        } else if (frm_source_reference1 === 'ALL') {
                            refreshDataTable(recrut_id, frm_source_reference1 = 'ALL', frm_nid);
                        } else {
                            refreshDataTable(recrut_id, frm_source_reference1, frm_nid);
                        }
                        toastr.success(data.success, '', {timeOut: 2000});
                    } else {
                        toastr.error(data.error, '', {timeOut: 2000});
