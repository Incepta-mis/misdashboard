            ...
            <section class="panel" id="data_table">
                <header class="panel-heading">
                    <label class="text-primary">
                        Deptartment Wise Vacant Report
                    </label>
                </header>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="vacant_id"
                                                       class="col-md-4 col-sm-6 control-label s_font"><b>Vacant
                                                        ID</b></label>
                                                <div class="col-md-8">
                                                    <select name="vacant_id"
                                                            id="vacant_id"
                                                            class="form-control input-sm"
                                                            style="font-size: 10px; height: 26px; padding: 0;">
                                        ...
                                        <div class=" col-md-4" style="padding: 0 90px;">
                                            <button type="button" id="display_data_vacant_report"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#section_name").on('change', function (){
                ...
                $.ajax({
                    type: "post",
                    url: '{{url('rms/report/dwv_get_vacant_info')}}',
                    datatype: 'json',
                    data: {
                        _token: '{{csrf_token()}}',
                        plant_id: $("#plant_name").val(),
                        dept_id: $("#department_name").val(),
                        section_id: $("#section_name").val()
                    },
                    success:function (response){
                        var data_path = response.get_vacant_info;
                        var option_vacant = '';

                        option_vacant += "<option value='ALL'>ALL</option>";
                        ...
                        $("#vacant_id").empty().append(option_vacant);
                    }
                })

            })

            $("#display_data_vacant_report").on('click', function () {
                ...
                if (plant_id === "") {
                    ...
                    toastr.error("Please Select Vacant ID")
                } else {
                    ...
                    $.ajax({
                        type: "post",
                        url: '{{url('rms/report/dwv_get_data_vacant_report')}}',
                        datatype: 'json',
                        data: {
                            _token: '{{csrf_token()}}',
                            plant_id: plant_id,
                        ...
                        success: function (response) {
                            ...
                            var var_table = $("#detail_list").DataTable({
                                data: response['get_data_vacant_report'],
                                dom: '<"toolbar">Bfrtip',
                                buttons: [
                                    {
