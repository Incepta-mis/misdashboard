...
@section('title','Product Details Entry Form')
@section('styles')
    ...
    <style>
        ...
        #load{
            ...
            position:fixed;
            z-index:9999;
            background:url("{{url('public/site_resource/images/loading.gif')}}") no-repeat center center rgba(0,0,0,0.25)
        }
...
@section('right-content')
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <select name="fip" id="fip"
                                                ...
                                                @foreach($expo_data as $l)
                                                    <option value="{{$l->plant_id}},{{ $l->product_code }} ,{{ $l->product_name }} ,{{ $l->export_country }},{{ $l->pack_size }},{{ $l->finish_product_code }}">{{$l->details}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-4">
                                            <input type="text" class="form-control input-sm" id="plant_id" name="plant_id">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="panel-body" style="padding-top: 2%;background-color: #E5E7E9">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="row" id="dosType" style="display: none";>
                                <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12">
                                    <div class="panel">
                                        <span class="label label-default">Dossier Type</span>
                                        API TYPE : <b><input type="text" id="v_api" disabled style="background-color: #FADBD8;"></b>
                                        PV : <b><input type="text" id="v_pv" disabled style="background-color: #FADBD8"></b>
                                        Impurity of FP : <b><input type="text" id="v_ipf" disabled style="background-color: #FADBD8"></b>
                                        CDP Match : <b><input type="text" id="v_cdp_match" disabled style="background-color: #FADBD8"></b>
                                        BE Study : <b><input type="text" id="v_be_study" disabled style="background-color: #FADBD8"></b>
                                    </div>
                                </div>
                            </div>
    ...
    {{--<!--Reused CTD Modal -->--}}
    <div id="reusedCtdModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                    <h4 class="modal-title">Reused CTD</h4>
                </div>
                <div class="modal-body">
                    ...
                    <form method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="reuse_api_type" class="col-lg-2 col-sm-2 control-label">API TYPE</label>
                            <div class="col-lg-10">
                                <select name="reuse_api_type" id="reuse_api_type"
                                        class="form-control input-sm" style="background: antiquewhite;">
                                    <option value="">SELECT API</option>
                                    <option value="API DMF">API DMF</option>
                                    <option value="API CTD">API CTD</option>
                        ...
                        <div class="form-group">
                            <label for="reuse_api_source" class="col-lg-2 col-sm-2 control-label">API Source</label>
                            <div class="col-lg-10">
                                <input id="reuse_api_source" name="reuse_api_source" multiple="" type="file"/>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="reuse_fp_spec" class="col-lg-2 col-sm-2 control-label">FP Spec</label>
                            <div class="col-lg-10">
                                <input id="reuse_fp_spec" name="reuse_fp_spec" multiple="" type="file"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="reuse_manufacturer" class="col-lg-2 col-sm-2 control-label">Manufacturer</label>
                            <div class="col-lg-10">
                                <input id="reuse_manufacturer" name="reuse_manufacturer" multiple="" type="file"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="reuse_stability" class="col-lg-2 col-sm-2 control-label">Stability</label>
                            <div class="col-lg-10">
                                <input id="reuse_stability" name="reuse_stability" multiple="" type="file"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="reuse_type_pv" class="col-lg-2 col-sm-2 control-label">PV</label>
                            <div class="col-lg-10">
                                <select name="reuse_type_pv" id="reuse_type_pv"
                                        class="form-control input-sm" style="background: antiquewhite;">
                                    <option value="">SELECT PV</option>
                                    <option value="C">C</option>
                                    <option value="R">R</option>
                        ...
                        <div class="form-group">
                            <label for="reuse_impurity" class="col-lg-2 col-sm-2 control-label">Impurity of FP</label>
                            <div class="col-lg-10">
                                <select name="reuse_impurity" id="reuse_impurity"
                                        class="form-control input-sm" style="background: antiquewhite;">
                                    <option value="">SELECT Impurity</option>
                                    <option value="YES">YES</option>
                                    <option value="NO">NO</option>
                        ...
                        <div class="form-group">
                            <label for="reuse_type_cdp" class="col-lg-2 col-sm-2 control-label">CDP Match</label>
                            <div class="col-lg-10">
                                <select name="reuse_type_cdp" id="reuse_type_cdp"
                                        class="form-control input-sm" style="background: antiquewhite;">
                                    <option value="">SELECT CDP Match</option>
                                    <option value="YES">YES</option>
                                    <option value="NO">NO</option>
                        ...
                        <div class="form-group">
                            <label for="reuse_beStudy" class="col-lg-2 col-sm-2 control-label">BE Study</label>
                            <div class="col-lg-10">
                                <select name="reuse_beStudy" id="reuse_beStudy"
                                        class="form-control input-sm" style="background: antiquewhite;">
                                    <option value="">SELECT BE Study</option>
                                    <option value="YES">YES</option>
                                    <option value="NO">NO</option>
