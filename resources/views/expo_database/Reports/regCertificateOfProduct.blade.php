            ...
            <section class="panel panel-info" id="data_table">
                <header class="panel-heading">
                    <label class="text-default">
                        Registration Certificate Of Product
                    </label>
                </header>
                                ...
                                {data: "approval_date"},
                                  {
                                    ...
                                    render: function(data, type, row, meta){
                                        if(data === null){
                                            ...
                                            if(type === 'display'){
                                                data = '<a target="_blank" style="color:#0000FF; font-size: small;" href="{{ url('public') }}' +"/"+ data + '">Open Certificate</a>';
                                            }
                                            return data;
                                        }
