...
@section('title','Export Product Details Status')
@section('styles')
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        <div class="col-md-4 col-sm-4 col-xs-4">
                                            <div class="form-group">
                                                <label class="col-sm-4 col-sm-4 control-label input-sm">Product Bulk Code</label>
                                                <div class="col-md-6 col-sm-6">
                                                    <select name="prod_bulk_code" id="prod_bulk_code"
                                                            class="form-control input-sm m-bot15 prod_bulk_code">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <h4><span>  {{ $status[0]->registered }}  </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <h4><span>  {{ $status[0]->permitted }}  </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <h4><span> {{ $status[0]->dropped }}   </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <h4><span> {{ $status[0]->rejected }} </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <h4> <span> {{ $status[0]->withdrawl }} </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-8">
                                    ...
                                    <h4><span > {{ $status[0]->sub_to_im }} </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <h4><span > {{ $status[0]->sub_to_agent }} </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <div class="col-xs-9">
                                    ...
                                    <h4><span > {{ $status[0]->sub_to_nra }} </span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.prod_bulk_code').select2();

            $('.prod_bulk_code').on('change', function () {
                var prod_bulk_code = $('.prod_bulk_code').val();


                console.log(prod_bulk_code);

                $('.product_name').append($('<option></option>').html('Loading...'));

                $.ajax({
                    type: 'post',
                    url: "{{ url('expo/report/prodBulkCodeWiseProductName') }}",
                    data: {prod_bulk_code: prod_bulk_code,"_token": "{{ csrf_token() }}"},
                    success: function (data) {

                        console.log('Bulk code is',data);
                        ...
                        if ((data.products.length) > 0) {
                            ...
                            for (var i = 0; i < data.products.length; i++) {
                                op += '<option value= " ' + data.products[i]['expo_product_name'] + ' ">' + data.products[i]['expo_product_name'] + '</option>';
                            }
                            $('.product_name').html(" ");
            ...
            $('.product_name').on('change', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: "{{ url('expo/report/pcodeWiseCountry') }}",
                    data: {product_name: product_name,prod_bulk_code:prod_bulk_code,"_token": "{{ csrf_token() }}"},
                    success: function (data) {
            ...
            $("#btn_display").click(function () {
                ...
                var data = { expo_country : expo_country,
                    product_name:product_name,prod_bulk_code:prod_bulk_code,"_token": "{{ csrf_token() }}"};
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: data,
                    url: "{{ url('expo/report/getQAWPSCurrentResult') }}",
