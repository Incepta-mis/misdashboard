...
@section('title','Expiry date Wise Status for Renewal')
@section('styles')
            ...
            <section class="panel panel-info" id="data_table">
                <header class="panel-heading">
                    <label class="text-default">
                        Expiry date Wise Status for Renewal
                    </label>
                </header>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            <select name="p_status" id="p_status"
                                                    class="form-control input-sm m-bot15 p_status">
                                                <option value="">Select Name</option>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btn_display").click(function () {
                ...
                var data = { expo_country : expo_country, year: year,
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: data,
                    url: "{{ url('expo/report/getErsResult') }}",
