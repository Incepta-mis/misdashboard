                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-2 col-sm-2 col-xs-6 input-sm" for="date_from"
                                ...
                                <b>Dcr Month</b></label>
                            <div class="col-md-2 col-sm-2 col-xs-6">
                                <select name="date_from" id="date_from" class="form-control input-sm">
                                    @foreach($dcr_mnth as $dmnth)
...
@section('scripts')
    ...
    {{Html::script('public/site_resource/js/dcr_scripts/dvsr_script2.js')}}
    <script>
        servloc = "{{url('dcrep/resp_dvs_rep')}}";servloc_t = "{{url('dcrep/resp_terr_id')}}";eid = "{{Auth::user()->user_id}}";desig = "{{Auth::user()->desig}}";
    </script>
@endsection
