...
@section('title','Item Wise Doctor Details Report')
@section('styles')
            ...
            <section class="panel" id="data_table">
                <header class="panel-heading">
                    <label class="text-primary">
                        Item Wise Doctor Details Report
                    </label>
                </header>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-2 col-sm-2 col-xs-6 input-sm" style="width: 12%;"
                                ...
                                <b>Item Name:</b></label>
                            <div class="col-md-2 col-sm-2 col-xs-6">
                                <select name="item_list" id="item_list" class="form-control input-sm">
                                    <option value="All">All</option>
                                    @foreach($items as $ttnam)
            ...
            <div class="col-sm-12 col-md-12">
                <section class="panel" id="data_table">
                    <div class="panel-body table-responsive">
                        <table id="itemw_docdetails_tab" class=" table-fixed-header table table-fixed table-condensed table-striped table-bordered"
                               width="100%">
...
@section('scripts')
    ...
    <!-- {{Html::script('public/site_resource/js/spin.min.js')}} -->
    {{Html::script('public/site_resource/dpicker/moment-with-locales.js')}}
    {{Html::script('public/site_resource/dpicker/bootstrap-datetimepicker.js')}}

    {{Html::script('public/site_resource/js/dcr_scripts/iwdd_script.js')}}

    <script>
        servloc = "{{url('dcrep/resp_iwdoc_detail_rep')}}";
        servloc_t = "{{url('dcrep/resp_itemwdoc_item_name')}}";
        eid = "{{Auth::user()->user_id}}";desig = "{{Auth::user()->desig}}";
        loc_rterr = "{{url('dcrep/resp_am_mpo_list')}}";
    </script>
@endsection
