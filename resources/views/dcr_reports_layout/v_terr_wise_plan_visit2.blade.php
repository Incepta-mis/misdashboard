...
@section('title','Territory Wise Plan VS Visit')
@section('styles')
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <label class="control-label col-md-2 col-sm-2 col-xs-6 input-sm" for="dcr_month"
                                   style="width: 12%;">
                                <b>Dcr Month</b></label>
                            <div class="col-md-2 col-sm-2 col-xs-6">
                                <select name="dcr_month" id="dcr_month" class="form-control input-sm">
                                    @foreach($dcr_month as $dmnth)
                                        <option value="{{$dmnth->mnth}}">{{$dmnth->mnth}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
            ...
            <div class="col-sm-12 col-md-12">
                <section class="panel" id="data_table">
                    <div class="panel-body table-responsive">
                        <table id="twplit"
                               class=" table-fixed-header table table-fixed table-condensed table-striped table-bordered"
                               width="100%">
...
@section('scripts')
    ...
    {{Html::script('public/site_resource/js/dcr_scripts/twpv_script.js')}}

    <script>
        servloc = "{{url('dcrep/resp_twpvsit_data_rep')}}";
        servloc_t = "{{url('dcrep/resp_twpvsit_data_list')}}";
