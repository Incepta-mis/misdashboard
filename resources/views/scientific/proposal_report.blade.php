...
<div class="col-xs-12 " style="text-align: center;">
    <span style="font-size: 20px;">SCIENTIFIC SEMINAR PROPOSAL</span><br>
</div>
    ...
    <div class="col-xs-12">
        <div class="row">
            <div class="col-xs-12">
                ...
                <br>
                <br>
                <span style="font-size: 15px;"><b>Proposal No. <span
                                style="
                                border-radius: 12px;
                                border: 1px solid black;
                                padding: 13px;
...
"
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td><span id="rcorners3"><b>{{$rs_data[0]->nop_proposed}}</b></span></td>
                    </tr>
                    <tr>
                        <td>Brand Name:</td>
...
<tr>
    ...
    <td style="text-align:right"><b>{{number_format($rs_data[0]->advance_budget)}}</b> </td>
</tr>
                    </tbody>
