                            ...
                            @foreach( $applicantData as $data)
                                <tr>
                                    <td style="display: none;">
                                        <input type="text" class="line_id" name="line_id"
                                                                      value="{{ $data->line_id }}">

                                        <input type="hidden" class="rcm_app_date" name="rcm_app_date"
                                                                      value="{{ $data->rcm_app_date }}">
                                    </td>
        ...
        <div class="col-md-12 col-sm-12">
            ...
            <div class="col-md-4 col-sm-4">
                <form id="" method="post" action="{{ url('scm_portal/trialFormPdf') }}">
                    ...
                    <div class="col-sm-12 col-md-12">
                        <input type="hidden" name="line_id" value="{{ $applicantData[0]->line_id }}">
                        @if( $applicantData[0]->rnd_emp_id == '' )
                            <button type="submit" disabled id="btn_displayNP_group" class="btn btn-warning btn-sm">
            ...
            <div class="col-md-4 col-sm-4">
                <div class="col-sm-12 col-md-12">
                    @if( $applicantData[0]->rnd_emp_id == '' )
                        <a target="_blank" disabled class="btn btn-primary btn-sm "
                           href="{{ asset('public\SCM\TrialReq\\'.$applicantData[0]->qua_file ) }}">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#btn_ReqCOA').attr('formtarget', '_blank');
        ...
        $(function () {
            ...
            $('.accept').on('click', function () {
                ...
                var rcm_app_date = $(this).closest("tr").find(".rcm_app_date").val();
                ...
                if(rcm_app_date == ""){
                    ...
                    $.ajax({
                        type: "post",
                        url: '{{url('scm_portal/trial_rndConcerned_confirm')}}',
                        data: {
