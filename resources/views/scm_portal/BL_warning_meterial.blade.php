...
@section('title','Block List Warning Material')
@section('styles')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#btn_display").click(function () {
                ...
                $('#blklistno').text(blk);
                $("#loader").show();
                var showAdminColumns = ("<?php echo e(Auth::user()->user_id); ?>" === '1014927' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1020372' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1020371' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1019899' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1019900' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1017988' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1009185' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1011808' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1014928' ||
                            "<?php echo e(Auth::user()->user_id); ?>" === '1010112') ? true : false;
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: dataxx,
                    url: "{{ url('scm_portal/get_stm_warning_data') }}",
                    success: function (resp) {
                        ...
                        table = $("#blk_list").DataTable({
                            ...
                            columns: [
                                {
                                    ...
                                    render: function(data, type, row, meta){
                                        if(type === 'display'){
                                            data = '<a target="_blank" style="color:#0000FF; font-size: 12px;"  href="{{ url('public/SCM/BlockListFiles') }}' +"/"+ data + '.pdf">' + data + '</a>';
                                        }
                            ...
                            columnDefs: [
                                ...
                                {
                                    targets: [2,3,6,7,8,9], /* column index */
                                    orderable: false, /* true or false */
                                },
                                {
                                    targets: -1,
                                    data: null,
                                    defaultContent: "<button type='button' class='btn btn-danger btn-xs edit-btn'><span class='glyphicon glyphicon-edit'></span>   </button>"
                                },
                                { targets: -1, visible : showAdminColumns }
                            ],
            ...
            $('#blk_list tbody').on( 'click', '.edit-btn', function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: insetRowData,
                    url: "{{ url('scm_portal/send_warning_data') }}",
                    success: function (resp) {
                        if (resp.success) {
