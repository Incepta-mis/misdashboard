...
@section('title','Block List Statement Summary')
@section('styles')
        ...
        $(document).ready(function () {
            ...
            $("#btn_display").click(function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: dataxx,
                    url: "{{ url('scm_portal/get_stm_summary_data') }}",
                    success: function (resp) {
                        ...
                        table = $("#blk_list").DataTable({
                            ...
                            columns: [
                                ...
                                {data: "currency"},
                                {
                                    ...
                                    render: function(data, type, row, meta){
                                        ...
                                        if(data!=null){
                                           data = '<a target="_blank" style="font-size: 20px;color:#0000FF;"  href="{{ url('public/SCM/AmendmentFiles') }}' +"/"+ data +'"> <i class="fa fa-file"></a>';
                            ...
                            columnDefs: [
                                ...
                                {
                                    targets: [2,3,4,5,6,7,8,9], /* column index */
