...
@section('title','Challan Receive Report')
@section('styles')
                        ...
                        <div class="col-md-12 col-sm-12 table-responsive">
                            ...
                            table-striped">
                                ...
                                <tr>
                                    ...
                                    <th>SAP CC</th>
                                    <th>SAP CWIP ID</th>
                                    <th>Supplier Invoice Or Challan No.</th>
                                    <th>Supplier Name</th>
                                    <th>Unit</th>
                                    <th>Qty</th>
                                    <th>Unit Price</th>
        ...
        $(document).ready(function () {
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                if(plant_id === ""){
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{  url('stationery/report/getCwipData') }}',
                        data: {
                            'plant_id':plant_id,
                            'it_name':it_name,
                            'ist_name':ist_name,
                            ...
                            '_token': "{{ csrf_token() }}" },
                        success: function (data) {
                            console.log("this is my challan data");
                            console.log(data);
