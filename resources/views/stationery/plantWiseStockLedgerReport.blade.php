...
@section('title','Item Stock Ledger Report')
@section('styles')
                                    ...
                                    <div class="col-md-12 col-sm-12 table-responsive">
                                        ...
                                        table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th>Issue Rcv. Qty</th>
                                                <th>Transfer Qty</th>
                                                <th>Transfer Rcv. Qty</th>
                                                <th>Challan Rcv. Qty</th>
                                                <th>Destruction Qty</th>
                                                <th>Sales Qty</th>
                                                <th>Use Qty</th>
                                                <th>Total Qty</th>
                                                <th>Unit</th>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $.ajax({
                type: 'get',
                url: '{{  url('stationery/report/getItemStockLedgerData') }}',
