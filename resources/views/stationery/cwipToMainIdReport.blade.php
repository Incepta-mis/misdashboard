                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <div class="col-md-4 col-sm-4">
                                            <label for="plant_id" class="col-md-3 col-sm-3 control-label fnt_size" style="padding-right:0px;"><b>Exists Plant</b></label>
        ...
        $(document).ready(function () {
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                if(plant_id === ""){
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{  url('stationery/report/getCwipToMainIdData') }}',
                        data: {
                            'plant_id':plant_id,
                            'it_name':it_name,
                            'ist_name':ist_name,
