...
@section('title','Insert Item Sales Information')
@section('styles')
...
@section('right-content')
                                            ...
                                            <div class="col-md-9 col-sm-9">
                                                <select id="srvc_id" name="srvc_id"
                                                    ...
                                                    @if(count($services) > 0)
                                                        ...
                                                        @endforeach
                                                    @else
                                                        <option selected disabled>There is no data</option>
                                                    @endif
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-3 col-sm-3">
                                            ...
                                            <div class="col-md-9 col-sm-9">
                                                <input type="text" class="form-control input-sm"
                                                       value="" placeholder="Input a GL" name="gl"
                                                       id="gl">
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3">
    ...
    <div id="editItemSalesModal" class="modal fade" role="dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="edit_qty" class="control-label col-sm-2"><span class='cls-req'>*</span>Quantity</label>
                            <div class="col-sm-10" id="edit_pr_qty_div">
                                <input type="number" class="form-control input-sm" value="" min="1" id="edit_qty">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit_unit" class="control-label col-sm-2"><span class='cls-req'>*</span>Unit</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_unit" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit_unit_price" class="control-label col-sm-2"><span class='cls-req'>*</span>Unit Price</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" id="edit_unit_price" value="" min="1">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit_origin_plant" class="control-label col-sm-2"><span class='cls-req'>*</span>Origin Plant</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_origin_plant" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit_username" class="control-label col-sm-2">Username</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label for="edit_reason" class="control-label col-sm-2"><span class='cls-req'>*</span>Reason</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="edit_reason" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="edit_status" class="control-label col-sm-2"><span class='cls-req'>*</span>Status</label>
                            <div class="col-sm-10">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btn_submit1').on('click', function (e) {
                ...
                if(service_id != null){
                    $.ajax({
                        type: 'post',
                        url: '{{  url('stationery/form/getItemSalesReport') }}',
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                if(com_code === "" || plant_id === "" || item_id === "" || item_name === "" || qty === "" || unit ===
                    "" || unit_price === "" || origin_plant === "" || dept === "" || reason === "" || status === ""){
                    Swal.fire({
                        title: 'Error!',
                    ...
                    $.ajax({
                        type: 'post',
                        url: '{{  url('stationery/form/insertSalesData') }}',
                        data: {
        ...
        $('#update_info').on('click', function (e) {
            ...
            if(qty === "" || unit === "" || unit_price === "" ||
                ...
                $.ajax({
                    type: 'post',
                    url: '{{  url('stationery/form/editSalesData') }}',
                    data: {
        ...
        function deleteThis(id){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'post',
                        url: '{{  url('stationery/form/deleteSalesData') }}',
