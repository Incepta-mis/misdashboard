        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Factory Manager Data Insert</h4>
                </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#sel_dept').change(function () {
                ...
                $.ajax({
                    type: 'get',
                    url: '{{  url('elm_portal/getRestDeptEmpData') }}',
            ...
            $('#dept').change(function () {
                ...
                $.ajax({
                    type: 'get',
                    url: '{{  url('elm_portal/getDeptEmpData') }}',
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{{  url('elm_portal/getFacManagerData') }}',
            ...
            $('#Create_btn').on('click', function (e) {
                ...
                var add_dpt = $('#sel_dept').val();
                var add_emp = $('#sel_emp').val();
                var surname = $('#emp_name').val();
                var desig = $('#emp_desig').val();

                $.ajax({
                    type: 'post',
                    url: '{{  url('elm_portal/createNewFacMangr') }}',
                    data: { 'sel_plant_id': add_pl, 'sel_dept_id':add_dpt, 'sel_emp_id': add_emp, 'surname':surname,
                        'desig':desig, '_token': "{{ csrf_token() }}"},
                    success: function (data) {
                        $("#loader").hide();
        ...
        function saveThis (obj) {
            ...
            $.ajax({
                type: 'post',
                url: '{{  url('elm_portal/facManagerUpdate') }}',
