...
@section('title','Travel Note Sheet Recommended By')
@section('styles')
            ...
            <section class="panel panel-info" id="data_table">
                <header class="panel-heading">
                    <label class="text-default">
                        Travel Note Sheet Recommended By
                    </label>
                </header>
    ...
    <script type="text/javascript">
        ...
        $('#btn_display').on('click',function () {
            ...
            if($.trim($('#doc_no').val()) == '' || $.trim($('#astatus').val()) == '' ){
                ...
                var url = "{{ route('international.intlGetTravelerRecByDocument') }}";
                $("#loader").show();
                $("#report-body").hide();
                $.ajax({
        ...
        $(document).on("click",".accept",function() {
            ...
            $.ajax({
                ...
                url: "{{ route('international.intlNoteSheetRecommendedApprBy') }}",
        ...
        $(document).on("click",".reject",function( ){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {document_no: document_no, st: st},
                url: "{{ route('international.intlNoteSheetRecommendedNotAppr') }}",
                success: function (resp) {
