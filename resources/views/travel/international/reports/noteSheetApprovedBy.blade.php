...
@section('title','Travel Note Sheet Approved By')
@section('styles')
    ...
    <script type="text/javascript">
        ...
        $('#btn_display').on('click',function () {
            ...
            if($.trim($('#doc_no').val()) == '' || $.trim($('#astatus').val()) == '' ){
                ...
                var url = "{{ route('international.intlGetTravelerAprByDocument') }}";
                $("#loader").show();
                $("#report-body").hide();
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        table = $("#example").DataTable({
                            ...
                            columns: [
                                ...
                                {
                                    data: "recommended_accept",
                                    "render": function (data, type, row) {
                                        //console.log("get row data =",row.dept_accept);
                                        if (row.recommended_accept === null) {
                                            return '<span class="label label-warning">Pending</span>';
                                        } else if (row.recommended_accept === 'YES') {
                                            return '<span class="label label-success "> Accepted </span>';
                                        } else if (row.recommended_accept === 'NO') {
                                            return '<span class="label label-danger "> Rejected </span>';
                                        }
                                    }
                                },
                                {
                                    data: "chairman_madam_accept",
                                    className: "saccept",
                                    "render": function (data, type, row) {
                                        //console.log("get row data =",row.dept_accept);
                                        if (row.chairman_madam_accept === null) {
                                            return '<span class="label label-warning">Pending</span>';
                                        } else if (row.chairman_madam_accept === 'YES') {
                                            return '<span class="label label-success "> Accepted </span>';
                                        } else if (row.chairman_madam_accept === 'NO') {
                                            return '<span class="label label-danger "> Rejected </span>';
                                        }
                                    }
                                },
        ...
        $(document).on("click",".accept",function() {
            ...
            $.ajax({
                ...
                url: "{{ route('international.intlNoteSheetApprovedApprBy') }}",
        ...
        $(document).on("click",".reject",function( ){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {document_no: document_no, st: st},
                url: "{{ route('international.intlNoteSheetApprovedNotAppr') }}",
                success: function (resp) {
