                        ...
                        <table id="example" class="display table table-striped table-bordered" style="width:100%">
                            ...
                            @foreach ($rs as $data)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if( $data->site_head_accept == 'NO' ) <span
                                                class="label label-danger">Rejected</span>
                                        @elseif( $data->site_head_accept == '' ) <span
                                                class="label label-warning">Pending</span>
                                        @elseif( $data->site_head_accept == 'YES' ) <span
                                                class="label label-success">Accepted</span>
                                        @endif
                                    </td>

                                    <td>
                                        @if( $data->plant_head_accept == 'NO' ) <span
                                                class="label label-danger">Rejected</span>
