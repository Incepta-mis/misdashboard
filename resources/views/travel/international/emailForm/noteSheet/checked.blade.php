...
@section('title','NoteSheet Checked By - International Approved ')
@section('styles')
                        ...
                        <div class="row" style="padding-top: 60px;">
                            <div class="col-md-12 col-sm-12 col-lg-12">
                                ...
                                <div class="col-md-3 col-sm-3" style="float: left">
                                    ...
                                    @else
                                        <button type="button" class="btn btn-info btn-sm accept" disabled > <i class="ico-file-check"> Verify </i>  </button>
                                ...
                                <div class="col-md-3 col-sm-3" style="float: left">
                                    <button type="button" class="btn btn-warning btn-sm accept" disabled > <i class="ico-file-check"> Pending </i>  </button>
    ...
    <script type="text/javascript">
        ...
        $(document).on("click",".accept",function() {
            ...
            $.ajax({
                ...
                url: "{{ route('international.intlTravelNoteSheetCheckedAppr') }}",
        ...
        $(document).on("click",".reject",function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {group_id: group_id},
                url: "{{ route('international.intlTravelNoteSheetCheckedNotAppr') }}",
                success: function (resp) {
                    console.log(resp);
                    if (resp.success) {
