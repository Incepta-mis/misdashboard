...
@section('title','Travel Plant Approved')
@section('styles')
    ...
    <script type="text/javascript">
        ...
        $('#btn_display').on('click',function () {
            ...
            if($.trim($('#req_emp_id').val()) == '' ||
                ...
                var url = "{{ route('international.plantHeadIntlGetTraveler') }}";
                $("#loader").show();
                $("#report-body").hide();
                        ...
                        success: function (data) {
                            ...
                            table = $("#example").DataTable({
                                ...
                                columns: [
                                    ...
                                    {
                                        data: 'plant_head_accept',
                                        className: "saccept",
                                        "render": function (data, type, row) {
                                            // console.log("get row data =",data);
                                            // console.log("get row data =",row.chairman_madam_accept);
                                            if ( row.plant_head_accept === null ) {
                                                return '<span class="label label-warning">Pending</span>';
                                            } else if (row.plant_head_accept === 'YES' ) {
                                                return '<span class="label label-success "> Accepted </span>';
                                            } else if (row.plant_head_accept === 'NO') {
                                                return '<span class="label label-danger "> Rejected </span>';
                                            }
                                        }
                                    },
    ...
    success: function (data) {
        ...
        $(document).on("click",".accept",function() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {id: id, st: st},
                url: "{{ route('international.intlTravelPlantHeadApproved') }}",
        ...
        $(document).on("click",".reject",function( ){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {id: id, st: st},
                url: "{{ route('international.intlTravelPlantHeadRejected') }}",
                success: function (resp) {
