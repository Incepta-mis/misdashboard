...
@section('title','Advance - Local Recommended')
@section('styles')
...
{{--                                {{ dd($data) }}--}}
                                ...
                                <tr>
                                    ...
                                    <td > {{ $data->amount }}</td>
                                    <td>
                                        @if( $data->sup_accept == 'NO' ) <span class="label label-danger">Rejected</span>
                                        @elseif( $data->sup_accept == '' ) <span
