...
@section('title','Travel Recommended')
@section('styles')
                    ...
                    <form class="form-horizontal" method="get" action="">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group">
                                        <label class="col-sm-4 col-sm-4 control-label input-sm">Travel Type: </label>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#btn_display').on('click',function () {
            ...
            if($.trim($('#req_emp_id').val()) == '' || $.trim($('#type').val()) == '' || $.trim($('#astatus').val()) == '' ){
                swal({
                    icon: 'error',
                    type: 'error',
                    text: 'Please select Employee, Travel Type and Status!'
                });
            }else {
                ...
                var url = "{{ route('local.travelList') }}";
                $("#loader").show();
                $("#report-body").hide();
                $.ajax({
        ...
        $(document).on("click",".accept",function() {
            ...
            $.ajax({
                ...
                url: "{{ route('local.travelSupApproved') }}",
        ...
        $(document).on("click",".reject",function( ){
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: {id: id, st: st},
                url: "{{ route('local.travelSupRejected') }}",
                success: function (resp) {
