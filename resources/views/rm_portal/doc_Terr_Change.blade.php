...
@section('title','Doctors Territory Rearrange')
@section('styles')
    ...
    <div class="row" id="report-body" style="display: none;">
                            ...
                            <div class="form-group">
                                <label for="emp_month"
                                       class="col-md-6 col-sm-6 control-label"><b>Am Terr
                                        Id:</b></label>
                                <div class="col-md-6">
                                    <select name="am_terr_ch" id="am_terr_ch"
                                            class="form-control input-sm">
                                        <option value="">Select Territory</option>
                            ...
                            <div class="form-group">
                                <label for="emp_month"
                                       class="col-md-6 col-sm-6 control-label"><b>MPO Terr
                                        Id:</b></label>
                                <div class="col-md-6">
                                    <select name="mpo_terr_ch" id="mpo_terr_ch"
                                            class="form-control input-sm">
                                        <option value="">Select Territory</option>
        ...
        <div class="">
            <div class="col-sm-12 col-md-12">
                <section class="panel" id="data_table">
                    <div class="panel-body">
                        <h4 class="text-center"><span style="color: red;">You can delete maximum 5 rows at a time.</span></h4>
...
{{--    {{Html::script('public/site_resource/js/dataTables.rowsGroup.js')}}--}}
    {{Html::script('public/site_resource/js/rm_portal_scripts/doc_terr_change.js')}}
    {{Html::script('public/site_resource/js/toast/toastr.min.js')}}


    <script type="text/javascript">

        servloc_mpo = "{{url('rm_portal/docmpoTerr')}}";
        servloc_mpo_latest = "{{url('rm_portal/itemWiseMpoTerrList')}}";
        servloc_am = "{{url('rm_portal/regWTerrAmList')}}";
        servloc_data = "{{url('rm_portal/mpoTerrWDoc')}}";
        servloc_save = "{{url('rm_portal/TerrWDocTrans')}}";
        servloc_deleteData = "{{url('rm_portal/twDocDelete')}}";
