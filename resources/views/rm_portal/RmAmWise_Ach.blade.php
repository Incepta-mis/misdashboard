                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="rm_terr" class="col-md-6 col-sm-6 control-label"><b>Region Terr
                                                Id:</b></label>
                                        <div class="col-md-6">
                        ...
                        @if (Auth::user()->desig === 'RM' || Auth::user()->desig === 'ASM')
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-lg-12 col-md-12">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="p_group" class="col-md-6 col-sm-6 control-label"><b>Product
                                                    Group:</b></label>
                                            <div class="col-md-6">
                                                <select name="p_group" id="p_group"
                                                    class="form-control input-sm p_group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="p_name" class="col-md-6 col-sm-6 control-label"><b>Product
                                                    Name:</b></label>
                                            <div class="col-md-6">
                                                <select name="p_name" id="p_name"
                                                    class="form-control input-sm p_name">
                                            ...
                                            <div class="col-md-6">
                                                <select name="p_group" id="p_group"
                                                    ...
                                                    @foreach ($p_group as $group)
                                                        <option value="{{ $group->p_group }}">{{ $group->p_group }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
        ...
        <div class="col-sm-12 col-md-12 col-xs-12">
            <section class="panel" id="data_table">
                <div class="panel-body">
                    ...
                    <div class="table table-responsive" style="display: none" id="table2">
                        <table id="example" class="display table table-bordered table-striped" style="width:100%">
                            <thead>
                                <tr class="bg-dark">
                                    <th class="text-center">PRODUCT NAME</th>
            ...
            if (!rm_terr || !am_terr || !brand_name) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#loader").hide();
                        $("#report-body").show();
                        $("#tbl_body_data").empty().append(`
                                <tr style="height:25px;" class="bg-primary">
                                    <td rowspan="2" class="text-center" style="font-size:13px;padding-top:1%"><span>${data.data[0].brand_name}</span></td>
                                    <td style="text-align:left">Qty</td>
                                    <td>${data.total_target_qty}</td>
                                    <td>${data.total_sold_qty}</td>
                                    <td>${data.total_int_qty}</td>
                                    <td>${data.total_exp_sale_qty}</td>
                                    <td></td>
                                    
                                </tr>
                                <tr style="height:25px;" class="bg-primary">
                                    <td style="text-align:left">Value</td>
                                    <td>${data.total_target_value}</td>
                                    <td>${data.total_sold_value}</td>
                                    <td>${data.total_int_value}</td>
                                    <td>${data.total_exp_sale_value}</td>
                    ...
                    $.each(data.product,function(cKey,cVal){
                        ...
                        $.each(data.product_wise_data[cKey],function(pwKey,pwVal){
                                ...
                                <tr style="padding:0px;height:25px;">
                                    <td rowspan="2" class="text-center" style="font-size:13px;padding-top:1%"><span>${pwVal.terr_id}</span></td>
                                    <td style="text-align:left">Qty</td>
                                    <td>${pwVal.target_qty}</td>
                                    <td>${pwVal.sold_qty}</td>
                                    <td>${pwVal.int_qty}</td>
                                    <td>${pwVal.exp_sale_qty}</td>
                                    <td></td>
                                    
                                </tr>
                                <tr style="padding:0px;height:25px;">
                                    <td style="text-align:left">Value</td>
                                    <td>${pwVal.target_value}</td>
                                    <td>${pwVal.sold_value}</td>
                                    <td>${pwVal.int_value}</td>
                                    <td>${pwVal.exp_sale_value}</td>
                                    <td>${pwVal.achivement}</td>
                                </tr>
                            `;
                            
                        });
                        $("#tbl_body_data2").append(`
                                <tr style="padding:0px;height:25px;" class="bg-danger">
                                    <td rowspan="2" class="text-center" style="font-size:13px;padding-top:1%"><span>${cVal}</span></td>
                                    <td style="text-align:left">Qty</td>
                                    <td>${data.product_data[cKey][0]}</td>
                                    <td>${data.product_data[cKey][2]}</td>
                                    <td>${data.product_data[cKey][4]}</td>
                                    <td>${data.product_data[cKey][6]}</td>
                                    <td></td>
                                    
                                </tr>
                                <tr style="padding:0px;height:25px;" class="bg-danger">
                                    <td style="text-align:left">Value</td>
                                    <td>${data.product_data[cKey][1]}</td>
                                    <td>${data.product_data[cKey][3]}</td>
                                    <td>${data.product_data[cKey][5]}</td>
                                    <td>${data.product_data[cKey][7]}</td>
                                    <td>${data.product_data[cKey][8]}</td>
                                </tr>
                                ${pwData}
                        `);
                    })
