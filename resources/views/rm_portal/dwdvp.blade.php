...
@section('title','Weekly Visit Report')
@section('styles')
    ...
    <style>
        ...
        /*.table-striped>tbody>tr:nth-child(odd)>th {*/
            /*background-color: #fffdf5; // Choose your own color here*/
        /*}*/
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title" id="brand_len"> Visit Summary </h3>
                </div>
                <div class="panel-body" id="brCnt">
                    Day :   <span id="selectDay" style="color: #2a88bd"></span> =>
                    Week-1 : <span id="w1" style="color: #2a88bd"> </span> ,
                    Week-2 : <span id="w2" style="color: #2a88bd"></span>  ,
                    Week-3 : <span id="w3" style="color: #2a88bd"></span>  ,
                    Week-4 : <span id="w4" style="color: #2a88bd"></span>
                </div>
            </div>
        </div>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table id="doc_list" class="table table-condensed table-striped table-bordered"
                                   width="100%">
                                <thead style="white-space:nowrap;" id="selectAll">
                                <tr>
                                    <th>DOCTOR_ID</th>
                                    <th>DOCTOR_NAME</th>
                                    <th style="text-align: center">WEEK1</th>
                                    <th style="text-align: center">DAY</th>
                                    <th style="text-align: center">WEEK2</th>
                                    <th style="text-align: center">DAY</th>
                                    <th style="text-align: center">WEEK3</th>
                                    <th style="text-align: center">DAY</th>
                                    <th style="text-align: center">WEEK4</th>
                                    <th style="text-align: center">DAY</th>
                                </tr>
                                </thead>
...
@section('scripts')
    ...
    {{Html::script('public/site_resource/js/rm_portal_scripts/dayWiseDocVisitPlantV2.js')}}
    ...
    <script type="text/javascript">
        ...
        servloc_data_new = "{{url('rm_portal/dwdvpd_new')}}";
        servloc_dwdup_new = "{{url('rm_portal/dayWiseDocPlanV2')}}";
