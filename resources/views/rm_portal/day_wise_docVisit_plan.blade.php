...
@section('title',' Day Wise Doctor Visit Plan')
@section('styles')
            ...
            <section class="panel" id="data_table">
                <header class="panel-heading">
                    <label class="text-primary">
                        Day Wise Doctor Visit Plan (Edit)
                    </label>
                </header>
                                    ...
                                    Auth::user()->desig === 'HO')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="v_day"
                                                           class="col-md-6 col-sm-6 control-label"><b>Day:</b></label>
                                                    <div class="col-md-6">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title" id="brand_len"> Summary </h3>
                </div>
                        ...
                        <div class="table-responsive">
                            <table id="doc_list" class="table table-condensed table-striped table-bordered"
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center">VW-1</th>
                                    <th style="text-align: center">WEEK-2</th>
                                    <th style="text-align: center">VW-2</th>
                                    <th style="text-align: center">WEEK-3</th>
                                    <th style="text-align: center">VW-3</th>
                                    <th style="text-align: center">WEEK-4</th>
                                    <th style="text-align: center">VW-4</th>
                                </tr>
                                </thead>
                                <tbody style="white-space:nowrap;overflow:hidden;"></tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="3"><b>Total Visit</b></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
...
{{--    {{Html::script('public/site_resource/js/dataTables.rowsGroup.js')}}--}}
    ...
    {{Html::script('public/site_resource/js/rm_portal_scripts/dayWiseDocVisitPlant.js')}}
    ...
    <script type="text/javascript">
        ...
        servloc_data = "{{url('rm_portal/dwdvpd')}}";
        servloc_dwdup = "{{url('rm_portal/dayWiseDocPlan')}}";
