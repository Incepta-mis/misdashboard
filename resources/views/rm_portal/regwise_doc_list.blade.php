...
@section('title','Region Wise Doctor List')
@section('styles')
...
@section('scripts')
    ...
    {{Html::script('public/site_resource/js/rm_portal_scripts/dcrlist_script.js')}}

    <script type="text/javascript">
        servloc_tid = "{{url('rm_portal/regwMpoTerrList')}}";
        servloc = "{{url('rm_portal/regTerrDocList')}}";
