...
@section('title','Item Wise Doctors')
@section('styles')
...
{{--    <link href="{{ url('public/site_resource/css/dataTables.checkboxes.css')}}" rel="stylesheet" type="text/css"/>--}}
                        ...
                        <form id="frm-example" action="" method="POST">
                            ...
                            <div class="table-responsive">
                                ...
                                <table id="doc_list" class="table table-condensed table-striped table-bordered"
                                    ...
                                    <tr>
                                        {{--<th style="text-align: center"><button type="button" id="selectAll"><i class="fa fa-file"></i></button> <button type="button" id="deselectAll"><i class="fa fa-file-o"></i> </button></th>--}}
                                        {{--<th style="text-align: center"><button type="button" id="selectAll"><i class="fa fa-file"></i></button></th>--}}
...
@section('scripts')
    ...
    {{Html::script('public/site_resource/js/rm_portal_scripts/itemWiseDoc.js')}}
    {{Html::script('public/site_resource/js/toast/toastr.min.js')}}

    <script type="text/javascript">
        servloc_loc = "{{url('rm_portal/itemWiseDoc')}}";
        ...
        servloc_item = "{{url('rm_portal/getItems')}}";
        servloc_data = "{{url('rm_portal/itemWiseDocData')}}";
        servloc_deleteData = "{{url('rm_portal/itemWiseDocDelete')}}";
