...
@section('title','Territory Wise Brand Exposure')
@section('styles')
...
@section('scripts')
    ...
    {{Html::script('public/site_resource/js/rm_portal_scripts/terrWiseBrandExposure.js')}}



    <script type="text/javascript">
        servloc_bnd = "{{url('rm_portal/getBrands')}}";
        servloc_data = "{{url('rm_portal/brandWiseDocExp')}}";
