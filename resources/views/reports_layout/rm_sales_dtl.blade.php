...
@section('title','RM Sales Details')
@section('styles')
                        ...
                        <table class="display table table-bordered table-striped table-responsive"  style="margin-bottom: 0px;">
                            @foreach($pgwsq as $key)
                                <tr>
                                    ...
                                    <!-- <td style="background-color: #C6DEFF">REPORT MONTH</td>
                    ...
                    <table>
                        <tr>
                            <td style="background-color:#fde9d9; padding: 5px;">
                                <label>RM Sales Details &nbsp; &nbsp; <span id="export_main"></span></label>
                    ...
                    <div class="adv-table  table-responsive">
                        ...
                        <table id="smws" class="display table table-bordered table-striped table-responsive">
                            ...
                            <tr>
                                ...
                                <th style="background-color: #FCD5B4">DSM/SM NAME</th>
                            ...
                            <tfoot>
                            <tr>
                                <th style="background-color: #CCFFCC;" colspan="7">Grand Total</th>
...
{{--    {{Html::script(' https://code.jquery.com/jquery-3.3.1.js')}}--}}
    ...
    {{Html::script('public/site_resource/js/custom/script_rm_sales_dtl.js')}}
    ...
    <script>
        ...
        var url_rm = "{{url('srep/resp_rm_sales_dtl')}}";
        var i_url = "{{url('public/site_resource/images/loading.gif')}}";
        initialize_table_rm_dtl(url_rm,i_url);
