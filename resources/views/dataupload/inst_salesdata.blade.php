...
@section('title','UPLOAD INST SALES DATA')
@section('styles')
            ...
            <section class="panel" id="data_table">
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        ...
                        {!! Form::open(array('url'=>'dataupload/post_inst_sales_data','method'=>'POST' ,'enctype'=>'multipart/form-data','class'=>'form-horizontal','files'=>true)) !!}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                {{Html::image('public/site_resource/images/inst_demo_format1.png')}}
                            </div>
                            {!! Form::close() !!}
                        </div>
                    </div>
