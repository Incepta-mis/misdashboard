...
@section('title','Summary of Stability Monitoring Data for PQR_24M3')
@section('styles')
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <section class="panel" id="data_table">
                <form action="" id="stabilitymonitoringdata24M3_info_data">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">Summary of Stability Monitoring Data for PQR_24M3(Selection Option)</legend>
                                    <form id="selection">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
        ...
        $(document).ready(function () {
            ...
            function preparereport1(values)
            {
                ...
                table +=' <thead>\n' +
                    ...
                    '        </tr>\n' +
                    '        <tr>\n' +
                    '            <th colspan="7" class="text-center">Long Term Stability Data</th>\n' +
                    '        </tr>\n' +
                    '        <tr>\n' +
            ...
            $('#pname').on('change', function () {
                if ($(this).val() !== 'ALL') {
                    $.ajax({
                        type: 'get',
                        url: '{{url('ssm/report/result/batchget10')}}',
                        data: {
            ...
            $('#btn_display').on('click', function () {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: '{{url('ssm/report/result/displayresult10')}}',
                    data: {
                            ...
                            buttons: [
                                {
                                    ...
                                    action: function () {
                                        ...
                                        window.location = '{{URL::to('ssm/report/result/exportexcel11/')}}' + '/' + $('#stabilitymonitoringdata24M3_info_data').serialize();
                                    }
                                },
                                {
                                    text: 'PDF',
                                    ...
                                    action: function () {
                                        // alert($('#sample_info_data').serialize());
                                        window.location = '{{URL::to('ssm/report/result/exportpdf11/')}}' + '/' + $('#stabilitymonitoringdata24M3_info_data').serialize();
                                    }
                                }
