...
<table  width="100%">
    ...
    <tr>
        ...
        <td colspan="1" ><span style="margin-left: 300px">Sample Quantity</span> </td>
    </tr>
    ...
    <tr>
        <td colspan="1"><span style="margin-left: 300px">Stability Start:{{$KOD}} </span></td>

        <td colspan="1">Stability End:</td>
    </tr>
    <tr>
        <td colspan="10">Label claim:</td>

        <td colspan="1">Ref. of STP : </td>
    </tr>
    </tbody>
</table>
<table width="100%" style="border-collapse: collapse">
    ...
    <tr>
        ...
        <th rowspan="3" style="text-align: center;border: 1px solid #0a0a0a">Acceptance Criteria</th>
        <th colspan="11" style="text-align: center ;border: 1px solid #0a0a0a">Stability Time Points (months)</th>
    </tr>
    <tr>
        <th colspan="8" style="text-align: center;border: 1px solid #0a0a0a">Long Term Stability Data <br>(30 °C ± 2 °C/65% RH ± 5% RH)</th>
        <th colspan="3" style="text-align: center ;border: 1px solid #0a0a0a">Accelerated Stability Data <br>(40 °C ± 2 °C/75% RH ± 5% RH)</th>
    </tr>
    <tr>
    ...
    @foreach($pdata1 as  $s)
        <tr>
            ...
            <td style="border: 1px solid #0a0a0a">{{$s->k}}</td>
        </tr>
        {{--        @php--}}
...
<table width="100%">
    ...
    <tr>
        <td colspan="2">Md. Noor Hasan Mithu</td>
        <td colspan="3"> K.M. Shamsul Arefin</td>
