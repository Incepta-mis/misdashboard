...
@section('title','Summary of Stability Monitoring Data for PQR_24M2')
@section('styles')
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <section class="panel" id="data_table">
                <form action="" id="stabilitymonitoringdata24M2_info_data">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">Summary of Stability Monitoring Data for PQR_24M2(Selection Option)</legend>
                                    <form id="selection">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
        ...
        $(document).ready(function () {
            ...
            function preparereport1(values)
            {
                ...
                for (var i=0;i<values.length;i++){
                    ...
                    table += '<tr><td>'+values[i].test_parameters+'</td><td>'+values[i].accept_criteria+'</td><td>'+ini1+'</td><td>'+ini2+'</td><td>'+ini3+'</td><td>'+ini4+'</td></tr>'
                }
                table +='</tbody></table>';
                return table;
            ...
            $('#pname').on('change', function () {
                if ($(this).val() !== 'ALL') {
                    $.ajax({
                        type: 'get',
                        url: '{{url('ssm/report/result/batchget9')}}',
                        data: {
            ...
            $('#btn_display').on('click', function () {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: '{{url('ssm/report/result/displayresult9')}}',
                    data: {
                            ...
                            buttons: [
                                {
                                    ...
                                    action: function () {
                                        ...
                                        window.location = '{{URL::to('ssm/report/result/exportexcel10/')}}' + '/' + $('#stabilitymonitoringdata24M2_info_data').serialize();
                                    }
                                },
                                {
                                    text: 'PDF',
                                    ...
                                    action: function () {
                                        // alert($('#sample_info_data').serialize());
                                        window.location = '{{URL::to('ssm/report/result/exportpdf10/')}}' + '/' + $('#stabilitymonitoringdata24M2_info_data').serialize();
                                    }
                                }
