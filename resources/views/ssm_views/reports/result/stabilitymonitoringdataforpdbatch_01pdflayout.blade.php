...
<table width="100%" style="border-collapse: collapse">
    ...
    <tr>
        <th colspan="2" style="text-align: center;border: 1px solid #0a0a0a">Long Term Stability Data <br>(30 °C ± 2 °C/65% RH ± 5% RH)</th>
        <th colspan="1" style="text-align: center ;border: 1px solid #0a0a0a">Accelerated Stability Data <br>(40 °C ± 2 °C/75% RH ± 5% RH)</th>
    </tr>
    <tr>
