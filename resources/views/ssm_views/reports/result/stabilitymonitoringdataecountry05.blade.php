...
@section('title','Summary of Stability Monitoring Data Export Country_05')
@section('styles')
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <section class="panel" id="data_table">
                <form action="" id="stabilitymonitoringdataecountry05_info">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <fieldset class="scheduler-border">
                                    <legend class="scheduler-border">Summary of Stability Monitoring Data Export
                                        Country_05(Selection Option)
                                    </legend>
                                    <form id="selection">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="test_parameters" id="test_parameters"
                                                        ...
                                                        @foreach($test_parameters as $tm)
                                                            <option @if($tm->test_parameters == 'DESCRIPTION')selected
                                                                    @endif value="{{$tm->test_parameters}}">{{$tm->test_parameters}}</option>
                                                        @endforeach
        ...
        $(document).ready(function () {
            ...
            function preparereport1(values) {
                ...
                table += ' <thead>\n' +
                    ...
                    '            <th ></th>\n' +
                    '            <th ></th>\n' +
                    '            <th colspan="7" class="text-center">RESULTS OF ANALYSIS</th>\n' +
                    '        </tr>\n' +
                    '<tr> '+
                    '            <th rowspan="2" style="text-align: center;vertical-align: middle">Tests</th>\n' +
                    '            <th rowspan="2" style="text-align: center;vertical-align: middle">Limits</th>\n' +
                    ...
                    '        </tr>\n' +
                    ' <tr>\n' +
                    '        <th style="text-align: center;vertical-align: middle">Test Parameters</th>\n' +
                    '        <th style="text-align: center;vertical-align: middle">Acceptance Criteria</th>\n' +
                    '                   <th class="text-center">40 °C ± 2 °C/75% RH ± 5% RH</th>\n' +
                    '                   <th class="text-center">40 condition result data</th>\n' +
                    '               </tr>'+
                    '        </thead>';
                table += '<tbody> ';
                ...
                for (var i = 0; i < values.length; i++) {
                    ...
                    table += '<tr><td>' + values[i].test_parameters + '</td><td>' + values[i].accept_criteria + '</td><td>' + ini1 + '</td><td>' + ini2 + '</td></tr>'
                }
                table += '</tbody></table>';
                return table;
            ...
            $('#pname').on('change', function () {
                if ($(this).val() !== 'ALL') {
                    $.ajax({
                        type: 'get',
                        url: '{{url('ssm/report/result/batchget26')}}',
                        data: {
            ...
            $('#btn_display').on('click', function () {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: '{{url('ssm/report/result/displayresult26')}}',
                    data: {
                            ...
                            buttons: [
                                {
                                    ...
                                    action: function () {
                                        ...
                                        window.location = '{{URL::to('ssm/report/result/exportexcel27/')}}' + '/' + $('#stabilitymonitoringdataecountry05_info').serialize();
                                    }
                                },
                                {
                                    text: 'PDF',
                                    ...
                                    action: function () {
                                        // alert($('#sample_info_data').serialize());
                                        window.location = '{{URL::to('ssm/report/result/exportpdf27/')}}' + '/' + $('#stabilitymonitoringdataecountry05_info').serialize();
                                    }
                                }
