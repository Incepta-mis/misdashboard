    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <section class="panel" id="data_table">
                <form action="" id="stabilitymonitoringdataecountry02_info">
        ...
        $(document).ready(function () {
            ...
            function preparereport1(values)
            {
                ...
                table +=' <thead>\n' +
                    ...
                    '            <th colspan="11" class="text-center">Stability Time Points (months)</th>\n' +
                    '        </tr>\n' +
                    '        <tr>\n' +
                    '            <th colspan="8" class="text-center">Long Term Stability Data  <br> (30 °C ± 2 °C/65% RH ± 5% RH)</th>\n' +
                    '            <th colspan="3" class="text-center">Accelerated Stability Data <br> (40 °C ± 2 °C/75% RH ± 5% RH)</th>\n' +
                    '        </tr>\n' +
                    '        <tr>\n' +
                ...
                for (var i=0;i<values.length;i++){
                    ...
                    var ini10 = values[i]['j'] ? values[i]['j'] : '';
                    var ini11 = values[i]['k'] ? values[i]['k'] : '';
                    table += '<tr><td>'+values[i].test_parameters+'</td><td>'+values[i].accept_criteria+'</td><td>'+ini1+'</td><td>'+ini2+'</td><td>'+ini3+'</td><td>'+ini4+'</td><td>'+ini5+'</td><td>'+ini6+'</td><td>'+ini7+'</td><td>'+ini8+'</td><td>'+ini9+'</td><td>'+ini10+'</td><td>'+ini11+'</td></tr>'
                }
                table +='</tbody></table>';
                return table;
            ...
            $('#pname').on('change', function () {
                if ($(this).val() !== 'ALL') {
                    $.ajax({
                        type: 'get',
                        url: '{{url('ssm/report/result/batchget23')}}',
                        data: {
            ...
            $('#btn_display').on('click', function () {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: '{{url('ssm/report/result/displayresult23')}}',
                    data: {
                            ...
                            buttons: [
                                {
                                    ...
                                    action: function () {
                                        ...
                                        window.location = '{{URL::to('ssm/report/result/exportexcel24/')}}' + '/' + $('#stabilitymonitoringdataecountry02_info').serialize();
                                    }
                                },
                                {
                                    text: 'PDF',
                                    ...
                                    action: function () {
                                        // alert($('#sample_info_data').serialize());
                                        window.location = '{{URL::to('ssm/report/result/exportpdf24/')}}' + '/' + $('#stabilitymonitoringdataecountry02_info').serialize();
                                    }
                                }
