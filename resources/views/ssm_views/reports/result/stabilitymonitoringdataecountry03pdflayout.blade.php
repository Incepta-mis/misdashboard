...
<table  width="100%">
    ...
    <tr>
        <td colspan="10">Stability Start:{{$KOD}}</td>

        <td colspan="1"><span style="margin-left: 300px">Stability End: </span></td>
    </tr>

    <tr>
        <td colspan="10">Manufacturer's Name:</td>

        <td colspan="1"><span style="margin-left: 300px">Ref. of STP: </span></td>
    </tr>

    <tr>
        <td colspan="10">Label claim:</td>

        <td colspan="1"><span style="margin-left: 300px">Stability conducted on:</span></td>
    </tr>
    </tbody>
</table>
<table width="100%" style="border-collapse: collapse">
    ...
    <tr>
        ...
        <th colspan="9" style="text-align: center ;border: 1px solid #0a0a0a">Stability Time Points (months)</th>
    </tr>
    <tr>
        <th colspan="7" style="text-align: center;border: 1px solid #0a0a0a">Long Term Stability Data <br>(30 °C ± 2 °C/65% RH ± 5% RH)</th>
