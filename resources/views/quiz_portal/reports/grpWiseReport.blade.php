...
{{--    {{Html::script('public/site_resource/js/dataTables.buttons.min.js')}}--}}
    ...
    <script type="text/javascript">
        ...
        $("#btn_display").click(function () {
            ...
            var data = {grp_id: gr_id, "_token": "{{ csrf_token() }}"};
                        ...
                        buttons: [
                            {
                                ...
                                customize: function ( xlsx ) {
                                    ...
                                    // $('row c[r="A2"]', sheet).attr('s', '42');
                                    $('row c[r="A2"]', sheet).attr('s', '51');

                                    $('c[r=B1]', sheet).attr( 's', '2' );
                                    $('c[r=B2]', sheet).attr( 's', '2' );
                                    $('c[r=B4]', sheet).attr( 's', '50' );
                                ...
                                customizeData: function(data){
                                    //We want the first line so we disabled the header above. Let's add in our descriptions.
                                    // Then we're going to add them to the top of the body and do the bolding ourselves with
                                    // the customize function.
                                    var desc = [
                                        ['Group ID',resp[0]['group_id']],
                                        ['Exam Date',resp[0]['exam_date']]
                                    ];
