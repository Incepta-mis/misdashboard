...
@section('scripts')
                ...
                if ($("#mpo_terr").val() == '' ) {
                    ...
                    // $("#display_table tbody tr").remove();
                        ...
                        var markup = "<tr>" +
                            ...
                            "<td >" + territory + "</td>" +
                            "<td><input type='text' name='market' onkeyup='this.value = this.value.toUpperCase();' class='form-control' autocomplete='off' ></td>" +
                            "<td ><select name='day' >" +
    ...
    "</tr>";
        ...
        // "<td><input type='checkbox' name='record'></td>" +
        // "<td >" + data[i].terr_id + "</td>" +
        // "<td><input type='text' name='market'  onkeyup='this.value = this.value.toUpperCase();' class='form-control' autocomplete='off' >" + data[i].market_name + "</td>" +
        // "<td >" + data[i].day + "</td>" +
        // "<td><input type='text' name='hospital' onkeyup='this.value = this.value.toUpperCase();' class='pname form-control' autocomplete='off' >" + data[i].hospital_name + "</td>" +
        // "<td><input type='text' name='chemist' onkeyup='this.value = this.value.toUpperCase();' class='pname form-control' autocomplete='off' >" + data[i].chemist_code + "</td>" +
        // "<td><input type='text' name='chname' onkeyup='this.value = this.value.toUpperCase();' class='pname form-control' autocomplete='off' >" + data[i].chemist_name + "</td>" +
        // "<td><input type='number' name='psale' onkeyup='this.value = this.value.toUpperCase();' class='pname form-control' autocomplete='off' >" + data[i].present_sales + "</td>" +
        // "</tr>";
                            }
