...
@section('title','Hospital Wise Chemist Report')
@section('styles')
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            let display_query= "{{url('nc/display_query_hwc_report')}} ";
            ...
            $("#mpo_terr").on('change', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        selOptsDOC += "<option value='ALL' >ALL</option>";
                        for (var j = 0; j < response.length; j++) {
