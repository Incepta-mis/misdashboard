    ...
    <div class="col-xs-10 col-xs-offset-1" style="padding-right: 0px;padding-left:0px;">
        <table style="width:100%;" class="table">
            ...
            <tr>
                <td>{{ $emp_name }}</td>
                <td>{{ $emp_id }}</td>
                <td>{{ $emp_desig_name }}</td>
                <td>{{ $emp_dept_name }}</td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left;width: 50%; border-right-color: white;border-bottom-color: transparent;">
                    <table style="width:100%;border:none;line-height: 2" class="table">
                        <tbody>
                        <tr>
                            <td style="text-align: left; border:none;padding: 0px;">
                                <table style="width:100%;" class="table">
                                    <tbody>
                                        <tr>
                                            <td style="text-align: left;border-color: white;padding: 0px;width: 33%;"><b>Period of leave:</b></td>
                                            <td style="text-align: left;border-color: white;padding: 0px;">From:<b
                                                        style="font-size: 12px;">
                                                    {{ $leave_from }}</b></td>
                                            <td style="text-align: left;border-color: white;padding: 0px;">To:<b
                                                        style="font-size: 12px;"> {{
                                            $leave_to }}</b></td>
                                        </tr>
                                    </tbody>
                        ...
                        <tr>
                            <td style="text-align: left; border:none"><span>Purpose of leave: {{ $purpose_of_leave }}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align: left; border:none"><span>Address during leave: {{ $add_during_leave }}</span></td>
                        </tr>
                        <tr>
                            <td style="text-align: left; border:none"><span>Contact no. : {{ $emp_contact_no }}</span></td>
                        </tr>
                        </tbody>
                    </table>
                </td>
                <td colspan="2" style="border-bottom-color: transparent;">
                    <table style="width:100%;" class="table">
                        <thead>
                        <tr>
                            <th colspan="5"><b>Leave (No. of days)</b></th>
                        </tr>
                        <tr>
                            <th>Casual</th>
                            <th>Medical</th>
                        ...
                        <tbody>
                        <tr>
                            <td>@if($type_of_leave == 'CASUAL') {{ $day_of_leave }} @else 0 @endif</td>
                            <td>@if($type_of_leave == 'MEDICAL') {{ $day_of_leave }} @else 0 @endif</td>
                            <td>@if($type_of_leave == 'ANNUAL') {{ $day_of_leave }} @else 0 @endif</td>
                            <td>@if($type_of_leave == 'MATERNITY') {{ $day_of_leave }} @else 0 @endif</td>
                            <td>{{ $day_of_leave }}</td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <table style="width:100%;" class="table">
                        <thead>
                        <tr>
                            <th style="width: 30%;">Permanent</th>
                            <th style="width: 15%;">@if($permaOrCasual == null) <b style="font-family: DejaVu Sans,
                            sans-serif;">✔</b> @endif</th>
                            <th style="width: 30%;">Casual</th>
                            <th style="width: 15%;">@if($permaOrCasual != null) <b style="font-family: DejaVu Sans,
                            sans-serif;">✔</b> @endif</th>
                        </tr>
                        </thead>
            ...
            <tr>
                <td colspan="4" style="text-align: left;border-bottom-color: transparent;">
                    <br>
                     <span>Duties will be carried out by (Name & Signature) : <b style="text-decoration: underline">{{
                     $rsp_emp_name }}</b>  N/A
                .</span>
                    <br>
                    <span>(Please write 'NA' if not applicable)</span>
                    <br>
                </td>
            </tr>
            <tr>
                <td colspan="2" style="text-align: left;border-right-color: transparent">
                    <br>
                    <span>Date: {{ $application_date }}</span>
                    <br>
                    <br>
                </td>
                <td colspan="2">
                    <br>
                    <span style="float: right;text-align: center;"> <b style="text-decoration: underline">{{ $emp_name }}</b> <br>
                        Signature of the employee (Applicant) </span>
                </td>
            </tr>
            </tbody>
        </table>
...
<div class="row" >
    <div class="col-xs-10 col-xs-offset-1" style="padding-right: 0px;padding-left:0px; ">
        <span><b>Recommendation / Approval: (Please tick - <b style="font-family: DejaVu Sans, sans-serif;">✔</b>)
            </b></span>
    </div>
</div>
<br>
<div class="row" >
    <div class="col-xs-10 col-xs-offset-1" style="padding-right: 0px;padding-left:0px; ">
        <table style="width:100%;" class="table">
            <thead>
                <tr>
                    <th style="width: 7%;">@if($sup_accept_date != null) <b style="font-family: DejaVu Sans, sans-serif;
">✔</b> @endif</th>
                    <th>Recommended</th>
                    <th style="width: 7%">@if($sup_accept_date == null) <b style="font-family: DejaVu Sans, sans-serif;
">✔</b> @endif</th>
                    <th>Not Recommended</th>
                    <th>@if($app_status == 'YES') <b style="font-family: DejaVu Sans, sans-serif;">✔</b> @endif</th>
                    <th>Approved</th>
                    <th>@if($app_status == 'NO') <b style="font-family: DejaVu Sans, sans-serif;">✔</b> @endif</th>
                    <th>Not Approved</th>
                </tr>
            </thead>
            <tbody>
            <tr>
                <td colspan="4" style="height: 100px;">
                    <span style="text-align: center;">@if($recommended_by != null)<b
                                style="font-size:12px;text-decoration:
                    underline">{{ $recommended_by }}, {{ $sup_accept_date }}</b>@else ____________________
                        @endif<br><b>Signature,
                            Supervisor</b>
                    </span>
                </td>
                <td colspan="4" style="height: 100px;">
                    <span style="text-align: center;">@if($approved_by != null)<b style="font-size:12px;text-decoration:
                    underline">{{ $approved_by }}, {{ $rcm_accept }}</b>@else ____________________ @endif<br>
                        <b>Signature,
                            Departmental Head</b>
                    </span>
                </td>
...
<div class="row">
    <div class="col-xs-10 col-xs-offset-1" style="padding-right: 0px;padding-left:0px;">
        <table style="width:100%;" class="table">
            <tbody>
            <tr>
                <td colspan="4" style="text-align: left;border-bottom-color: transparent;padding: 10px;">
                    <span><b>LEAVE STATUS:</b></span>
                </td>
            </tr>
            <tr>
                <td style="width: 23%; border-right-color: white; border-bottom-color: transparent;padding-top:
                    20px">
                    <span><b>Availed</b><br><br><b>Balance</b></span>
                </td>
                <td colspan="3" style="border-bottom-color: transparent;">
                    <table class="table">
                        <thead>
                        <tr>
                            <th style="width: 68px;border-left-color: white; border-right-color: white; border-top-color: white;">Casual</th>
                            <th style="width: 68px;border-right-color: white; border-top-color: white;">Medical</th>
                            <th style="width: 68px;border-right-color: white; border-top-color: white;">Annual</th>
                            <th style="width: 68px;border-right-color: white; border-top-color: white;">Maternity</th>
                            <th style="width: 68px;border-right-color: white; border-top-color: white;">Other</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            <td>{{ $leaveStatus[1]->casual }}</td>
                            <td>{{ $leaveStatus[1]->medical }}</td>
                            <td>{{ $leaveStatus[1]->annual }}</td>
                            <td>{{ $leaveStatus[1]->maternity }}</td>
                            <td>{{ $leaveStatus[1]->special_medical }}</td>
                        </tr>
                        <tr>
                            <td>{{ $leaveStatus[2]->casual }}</td>
                            <td>{{ $leaveStatus[2]->medical }}</td>
                            <td>{{ $leaveStatus[2]->annual }}</td>
                            <td>{{ $leaveStatus[2]->maternity }}</td>
                            <td>{{ $leaveStatus[2]->special_medical }}</td>
                        </tr>
                        </tbody>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td colspan="2" style="padding-top: 18px;">
                        <span style="text-align: center">@if($final_approved_by == null) __________________ @else <b
                                    style="font-size:12px;text-decoration: underline">{{ $final_approved_by_name }}, {{ $updated_at }}</b>
                            @endif
                            <br><b>HR Officer</b></span>
                </td>
            </tr>
            </tbody>
        </table>
