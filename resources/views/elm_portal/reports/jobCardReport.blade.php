...
@section('right-content')
    <div class="row">
        ...
        <div id="emp_status" style="display: none">
            <div class="row">
                    ...
                    <div class="col-sm-12">
                        <section class="panel panel-danger">
                            ...
                            <div class="panel-body">
                                ...
                                {{--                                <table id="empWorkSt" class="table table-bordered">--}}
                                {{--                                    <thead>--}}
                                {{--                                    <tr>--}}
                                {{--                                        <th>HOLIDAY</th>--}}
                                {{--                                        <th>PRESENT</th>--}}
                                {{--                                        <th>LATE IN</th>--}}
                                {{--                                        <th>ABSENT</th>--}}
                                {{--                                        <th>INTIME MISSING</th>--}}
                                {{--                                        <th>OUTTIME MISSING</th>--}}
                                {{--                                        <th>EARLY OUT</th>--}}
                                {{--                                        <th>LATE IN AND EARLY OUT</th>--}}
                                {{--                                    </tr>--}}
                                {{--                                    </thead>--}}
                                {{--                                    <tbody>--}}
                                {{--                                    </tbody>--}}
                ...
                <div class="panel-body">
                    <div class="col-md-12 col-sm-12">
                        <table id="elr" width="100%" class="table table-bordered table-condensed table-striped">
                            ...
                            <tfoot>
                            <tr>
                                <td colspan="6" style="text-align: right;"> Duty Hours</td>
                                <td></td>
                            </tr>
                            </tfoot>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{!! URL::to('elm_portal/getJobRpt') !!}',
                    data: {
                        'dept_id': dpt,
                        'plant_id': pl,
                        'emp_id': emp,
                ...
                $.ajax({
                    type: 'post',
                    url: '{!! URL::to('elm_portal/getEmpWorkingStatus') !!}',
                    data: {
                        'dept_id': dpt,
                        'plant_id': pl,
                        'emp_id': emp,
                    ...
                    success: function (resp) {
                        ...
                        $.each(resp, function (i, item) {
                            ...
                            trHTML += '<td style="text-align: right;"><b>' + item.working_status + '</b></td><td style="background-color:powderblue; text-align: center" ><b>' + item.status + '</b></td>';
                        });
                        trHTML += '</tr>';
                        console.log(trHTML);
                        $('#results').empty().append(trHTML);
