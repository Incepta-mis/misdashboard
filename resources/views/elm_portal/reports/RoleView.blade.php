                ...
                <section class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>1</td>
                                <td>ELM GENERAL PEOPLE</td>
                                <td>15</td>                                
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>ELM SUPERVISOR / RECOMMENDED BY</td>
                                <td>16</td>                                
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>ELM DEPT HEAD / APPROVED BY</td>
                                <td>17</td>                                
                            </tr>
                            <tr>
                                <td>4</td>
                                <td>ELM RECOMMENDED BY and APPROVED BY</td>
                                <td>20</td>                                
                            </tr>
                            <tr>
                                <td>5</td>
          ...
          <div class="modal-body">
            <form class="form-horizontal" id="elm_emp" method="get">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10"> 
                  <input type="email" class="form-control input-sm" name="p_grp" id="p_grp" placeholder="Enter Product Group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10"> 
                  <input type="email" class="form-control input-sm" name="terr_id" id="terr_id" placeholder="Enter Territory ID">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10"> 
                  <input type="email" class="form-control input-sm" name="email" id="email" placeholder="Enter Email">
                </div>
              </div>
              <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{!! URL::to('elm_portal/getElmRoleInfo') !!}',
			...
			$(document).on('dblclick', '.editable', function(){										
				...
				emp_id      = $(this).parent().find('td').eq(0).html().trim();
				clcolName   = $('#elr thead tr th').eq($(this).index()).html().trim();

				// alert('Data:'+$(this).html().trim());
				// alert('Row:'+$(this).parent().find('td').eq(1).html().trim());
			...
			$(document).on('blur', '.update', function(){
				...
				{
					$.ajax({
						url : '{{ url("elm_portal/elmUpRoleInfo") }}',
						method : 'post',
						data : 
						{
							empId      : emp_id,
			...
			$('#elm_btn').on('click',function(e){				
				...
				$.ajax({
				    type: "get",
				    url: "{{ url('elm_portal/insElmRoleInfo') }}",
