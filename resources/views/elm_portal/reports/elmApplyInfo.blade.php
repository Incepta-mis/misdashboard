                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="col-md-10 col-sm-10">
                                                <select id="emp" name="emp"
                                                        class="form-control input-sm filter-option pull-left emp">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{!! URL::to('elm_portal/getApplicantLeave') !!}',
                    data: {'dept_id': dpt, 'plant_id': pl, 'emp_id': emp, '_token': "{{ csrf_token() }}"},
                    success: function (data) {

                        console.log('showing rsponse = ',data);
                        ...
                        table = $("#elr").DataTable({
                            ...
                            columns: [
                                ...
                                {data: "type_of_leave"},
                                {
                                    data: null,
                                    "render": function (row) {
                                        return "<button  class='btn btn-danger btn-xs sp_accept '><span class='glyphicon glyphicon-remove'></span>  </button>";
                                    }
                                }
                            ],
                            language: {
            ...
            $('#elr tbody').on( 'click', '.sp_accept', function (e) {
                var $button = $(this);
                ...
                swal({
                    ...
                    if (isConfirm.value === true) {
                        ...
                        swal({
                            title: 'Deleted!',
                            text: 'Application Leave are successfully Deleted!',
                            icon: 'success'
                        }).then(function () {                      
                            $.ajax({
                                method: "get",
                                url: '{{url('elm_portal/deleteApplicantLeave')}}',
                                data: {
                                    _token: '{{csrf_token()}}',
                                    line_id: line_id,
                                    emp_id: emp_id
