...
@section('title','ELM Maternity Info')
@section('styles')
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" id="elm_emp" method="get">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="no_of_lv">No.of LV:</label>
                <div class="col-sm-10"> 
                  <input type="text" class="form-control input-sm" name="no_of_lv" id="no_of_lv" placeholder="Enter Number of Leave">
                </div>
              </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btn_submit').on('click', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '{!! URL::to('elm_portal/getElmMaternityMasterInfo') !!}',
                    data: { 'plant_id': pl, 'emp_id': emp, '_token': "{{ csrf_token() }}"},
                    success: function (data) {
                        ...
                        table = $("#elr").DataTable({
                            ...
                            columns: [
                                {data: "plant_id"},
                                {data: "emp_id" , className:"editable"},
                                {data: "no_of_leave" , className:"editable"}                                                                                   
                            ],
                            language: {
			...
			$(document).on('dblclick', '.editable', function(){										
				...
				emp_id      = $(this).parent().find('td').eq(1).html().trim();
			...
			$(document).on('blur', '.update', function(){
				...
				{
					$.ajax({
						url : '{{ url("elm_portal/elmUpMatmasterInfo") }}',
						method : 'post',
						data : 
						{
							empId      : emp_id,
			...
			$('#elm_btn').on('click',function(e){				
				...
				$.ajax({
				    type: "get",
				    url: "{{ url('elm_portal/insElmMatMasterInfo') }}",
