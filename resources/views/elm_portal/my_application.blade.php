...
{{--                            {{ dd($data) }}--}}
                            ...
                            <tr>
                                ...
                                <td>
                                    @if( $data->sup_accept == 'NO' && $data->sup_rejected_id == '') <span
                                            class="label label-warning">Pending</span>
                                    @elseif( $data->sup_accept == 'YES' ) <span
                                            class="label label-success">Accept</span>
                                    @elseif( $data->sup_rejected_id != '' ) <span
                                            class="label label-danger">Rejected</span>
                                    @endif
                                </td>
                                <td>
                                    @if(  $data->rcm_approved_date == '' && $data->head_rejected_id == '' )<span
                                            class="label label-warning">Pending</span>
                                    @elseif( $data->rcm_approved_date != '' ) <span
                                            class="label label-success">Accept</span>
                                    @elseif( $data->head_rejected_id != '' ) <span
                                            class="label label-danger">Rejected</span>
                                    @endif
                                </td>
                                <td>
                                    @if( ($data->rsp_accept != 'NO'  )
                                         || ($data->sup_accept == 'YES' || $data->sup_rejected_id != '')
                                         || ($data->head_rejected_id != '' || $data->rcm_approved_date != ''))
                                    ...
                                    @else
                                        <button type="button" data-id="{{$data->line_id}}" data-toggle="modal"
                                                class='btn btn-info btn-xs edit-btn'><span
                                                    class="glyphicon glyphicon-edit"></span> Edit
                                        </button>
