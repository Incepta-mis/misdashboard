                    ...
                    <div class="table table-responsive">
                        ...
                        @foreach ($appData as $data)
                            ...
                            <tr>
                                ...
                                {{--<td style="display: none;">    <input type="text" id="emp_id" class="emp_id" name="emp_id" value="{{ $data->emp_id }}"> </td>--}}
                                {{--<td style="display: none;">    <input type="text" id="emp_email" class="emp_email" name="emp_email" value="{{ $data->emp_email }}"> </td>--}}
                                {{--<td style="display: none;">    <input type="text" id="emp_name" class="emp_name" name="emp_name" value="{{ $data->emp_name }}"> </td>--}}

                                <td class="line_id" style="display: none;"> {{$data->line_id}}  </td>
                                <td class="emp_id" style="display: none;"> {{ $data->emp_id }}  </td>
                                <td class="emp_email" style="display: none;"> {{ $data->emp_email }}   </td>
                                ...
                                <td>
                                    ...
                                    @if($data->sup_rejected_id != '')
                                        <button type="button" class='btn btn-primary btn-xs acpt disabled'><span
                                    ...
                                    @elseif( $data->sup_accept == 'NO' && $data->rcm_approved_date == '' )
                                        ...
                                        <button type="button" class="btn btn-danger btn-xs reject" id="reject"><span class="glyphicon glyphicon-remove"></span> Reject</button>
                                    @else
                                            <button type="button" class='btn btn-primary btn-xs acpt disabled'><span
                                                        class="glyphicon glyphicon-edit"></span> Edit
                                            </button>
                                ...
                                {{--@if($data->status == 'NO')--}}
                                    ...
                                    {{--<input type="hidden" id="emp_id" class="emp_id" name="emp_id" value="{{ $data->emp_id }}">--}}
                                    {{--<input type="hidden" id="emp_email" class="emp_email" name="emp_email" value="{{ $data->emp_email }}">--}}
                                    {{--<input type="hidden" id="emp_name" class="emp_name" name="emp_name" value="{{ $data->emp_name }}">--}}
                                {{--@endif--}}
                            </tr>
                        @endforeach
                        </tbody>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <select name="rsp_emp" id="rsp_emp"
                                                                            class="form-control input-sm  rsp_emp" style="width: auto; font-size: 7px;">
...
@section('scripts')
    ...
    <script type="text/javascript">
            ...
            $('.edit-btn').on("click", function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // var mgt_st =  data.resp_data[0].mgt_status;
                        // if (mgt_st != 'NM'){
                            var selOptsRsp = "";
        ...
        $(function () {
            ...
            // $('#example').on('click', 'tbody .accept', function (e) {

                // $('#example tbody').on('click', '.accept', function (e) {



                    // console.log( dtable.row( this ).data() );
                ...
                var line_id = $(this).closest("tr").find(".line_id").text();
                ...
                $.ajax({
                    type: "post",
                    url: '{{url('elm_portal/app_sup_confirm')}}',
            ...
            $('.reject').on('click',function(){
                ...
                var emp_email = $(this).closest("tr").find(".emp_email").text();
                var emp_name = $(this).closest("tr").find(".emp_name").text();
                var reject_val = $(this).closest("tr").find(".reject").val();
                ...
                $.ajax({
                    type: "post",
                    url: '{{url('elm_portal/sup_app_reject')}}',
                    async: false,
