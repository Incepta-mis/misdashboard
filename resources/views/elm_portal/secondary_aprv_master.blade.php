            ...
            <section class="panel panel-info" id="data_table">
                <header class="panel-heading">
                    <label class="text-default">
                        Approved BY ( Only Department Use )
                    </label>
                </header>
        ...
        $(document).ready(function() {
            ...
            $("#btn_display").click(function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: 'json',
                    data: {emp_id: req_emp_id},
                    url: "{{ url('elm_portal/secgetLeaveList') }}",
                    success: function (resp) {
                        ...
                        //for reject button
                        $('#example tbody').on('click', 'button.reject', function () {
        ...
        $(document).ready(function() {
            ...
            $("#btn_display").click(function () {
                ...
                $.ajax({
                    type: "GET",
                    dataType: 'json',
                    data: {emp_id: req_emp_id,a_status:$('#astatus').val().trim()},
                    url: "{{ url('elm_portal/secgetLeaveList') }}",
                    success: function (resp) {
