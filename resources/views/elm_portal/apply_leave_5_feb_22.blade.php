        ...
        $(function () {
            ...
            $('#tol').on('change', function () {
                ...
                if (currentValue === 'CASUAL') {
                    ...
                    .done(function (data) {
                        ...
                        // if (data[0].plant_id == '1000' || data[0].plant_id == '7000') {
                            // if (data[0].plant_id !== '1100' || data[0].plant_id !== '2100' ||
                            //     data[0].plant_id !=='1300' || data[0].plant_id !=='1400' ||
                            //     data[0].plant_id !=='2200'  || data[0].plant_id !=='4100' ||
                            //     data[0].plant_id !=='5100'
                            // ) {

                            var v_plant_id = data[0].plant_id;
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    console.log("Holiday Count: ",parseInt(data[0].holiday_cnt));
            ...
            $('form#appfrm').submit(function () {
                ...
                /*if (absentDateArr.length > 0) {
                    ...
                    // console.log(' First date=',d1);
                    // console.log(' second date=',d2);
                    // console.log(' Absent Date =',absentDateArr);
                    // console.log(' Absent Date =',absentDateArr[0]);
                    ...
                    if(absentDateArr[0] !== d1){
                         ...
                         let chkDate = false;
                         for(i = 0; i < absentDateArr.length; i++){
                             if(absentDateArr[i] >= d1 &&   absentDateArr[i] <= d2) {
                                 // alert('Yes');
                                 chkDate = true;
                             }
                         }
                        ...
                        //  console.log('Yes First date=',d1);
                        //  console.log('Yes second date=',d2);
                ...
                if (absentDateArr.length > 0) {
                    ...
                    var d1 = Date.parse($('#date1').val());
                    var d2 = Date.parse($('#date2').val());

                    if(Date.parse(absentDateArr[0]) !== d1){
                        swal({
                            type: 'error',
                            text: 'Please apply starting date first.!'
                        });
                        return false;
                    }else{
                        // console.log('I am in: ' , absentDateArr[0]);
                        // console.log('First Date: ' , d1);
                        // console.log('Last Date: ' , d2);
                        // console.log('AbsentDateArr Lenght: ' , absentDateArr.length);
                        //var chkDate = false;
                        for(let i = 0; i < absentDateArr.length; i++){

                            // console.log('Date :', absentDateArr[i]);
                            // console.log('Parse Date :', Date.parse(absentDateArr[i]));

                            /*if(Date.parse(absentDateArr[i]) >= d1 &&   Date.parse(absentDateArr[i]) <= d2) {
                                // alert('Yes');
                                chkDate = true;
                            }*/


                            if(Date.parse(absentDateArr[i]) >= d1 ) {
                                // alert('Yes');
                                chkDate = true;
                            }else{
                                chkDate = false;
