...
<body>
    ...
    <div class="row" style="font-size: 12px;">
        ...
        <div class="row" style=" margin-left: 3%;margin-right: 3%;">
            {{--<div class="col-xs-8">--}}
            <span style="float: left;">Depot : {{$rdata[0]->depot_id}} - {{$rdata[0]->depot_name}}</span> <span style="float: right;"> Month: : {{$rdata[0]->req_month}}</span><br>
    ...
    <div class="row" style=" font-size: 11px;margin-left: 1%;margin-right: 1%;">
        <table border="1" width="100%">
            <tr style="border: 1px solid #000000;">
                ...
                <td style="text-align: center;font-weight: bold;">Unit Price (TP+VAT)</td>
                <td style="text-align: center;font-weight: bold;">Total (TP+VAT)</td>
            </tr>
