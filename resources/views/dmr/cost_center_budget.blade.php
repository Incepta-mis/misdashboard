...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        subtract_budget_calc = "{{url('dmr/subtract_budget_calc')}}";
        cc_budget_display = "{{url('dmr/cc_budget_display')}}";
        insert_cc_budget = "{{url('dmr/insert_cc_budget')}}";
        cc_budget_history = "{{url('dmr/cc_budget_history')}}";
                        ...
                        $.ajax({
                            ...
                            success: function (resp) {
                                ...
                                if (Math.abs(proposed_negative_amount) <= subtract_exp_amount) {
                                    ...
                                    toastr.info('Subtraction amount exceeds expense amount ');
                                }
