                            ...
                            <div class="form-group">
                                <div class="col-sm-12 col-md-12">
                                    ...
                                    <div class="col-sm-4 col-md-4">
                                        ...
                                        {{--Added RM Name      Author:: Sahadat    --}}
                                        <div class="col-sm-4 col-md-4" style="padding-right: 0px; padding-left: 0px;">
                                            <label class="control-label col-md-4 col-sm-4 input-sm" for="p_group">
                                                <b>RM Name:</b></label>
                                            <div class="col-md-8 col-sm-8">
                                                <input style="padding-right: 0px;padding-left: 2px;" class="form-control input-sm" type="text" name="e_rm_name" id="e_rm_name"  disabled>
                                            </div>
                                        </div>
                                        {{--RM name section ended here --}}
                                    @endif
                                ...
                                <div class="col-sm-12 col-md-12" style="padding-top: 5px;padding-bottom: 5px">
                                    @if(Auth::user()->desig!='MPO')
                                        ...
                                        {{--Added AM Name      Author:: Sahadat    --}}
                                        <div class="col-sm-4 col-md-4" style="padding-right: 0px; padding-left: 0px;">
                                            <label class="control-label col-md-5 col-sm-5 input-sm" for="p_group">
                                                <b>AM Name:</b></label>
                                            <div class="col-md-7 col-sm-7 input-sm">
                                                <input style="padding-right: 0px;" class="form-control input-sm" type="text" name="e_am_name" id="e_am_name"  disabled>
                                            </div>
                                        </div>
                                        {{--AM name section ended here --}}
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (len <= 0) {
                            ...
                            } else if (log_desig == 'RM' || log_desig == 'ASM') {
...
//                            viewdata+="<td></td>";
                            ...
                            viewdata += "<td style='color:#9b0062' colspan='8' class='total_sum_final_inword'>" + convertNumberToWords(sum) + " Taka Only</td>";
                            viewdata += "<td colspan='2'></td>";
...
//                                            }
                                        ...
                                        $("#update_expense").modal({backdrop: 'static', keyboard: false},'show');
//                                        $("#ta_image").empty();
//                                        ('input[type="text"]
