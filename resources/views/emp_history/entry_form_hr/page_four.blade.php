    ...
    <form method="post" id="frm_pagefour">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-2 col-sm-2 text-center">
                    <input type="hidden" id="url_n"
                           value="{{url('ehf/nomineeImage')}}|{{url("public/emp_history_img/nominee/")}}">
                    <div class="loader">
            ...
            <span class="pull-right">
                ...
                <a style="text-decoration: none;" href="{{url('ehf/emp_final_pdfform_preview')}}" target="_blank">
                    <button class="btn btn-info btn-sm page_final_preview" type="button">
                        Preview
                    </button>
                </a>
