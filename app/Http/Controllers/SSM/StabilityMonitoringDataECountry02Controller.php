...
class StabilityMonitoringDataECountry02Controller extends Controller
{
    public function index()
    {
        ...
        order by 1 asc');
        return view('ssm_views.reports.result.stabilitymonitoringdataecountry02',compact('pname','batch_number','export_country','test_parameters'));
    }
...
and average_result_time in ('INITIAL','1M','3M','6M','9M','12M','18M','24M')
and sd.pname = ?
and sd.batch_number = ?
and sd.Country_Name = ?
union all
...
and sd.batch_number = ?
and sd.Country_Name = ?
))pivot (max(average_result) for row_no in (1 as a,2 as b,3 as c,4 as d,5 as e,6 as f,7 as g,8 as h,9 as i,10 as j,11 as k))
...
//            dd ($data);
            ...
            \Excel::create('Summary', function ($excel) use ($data) {
                ...
                $excel->sheet('Summary', function ($sheet) use ($data) {
                    $sheet->loadView('ssm_views.reports.result.stabilitymonitoringdataecountry02excellayout', $data);
